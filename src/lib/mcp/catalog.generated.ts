// AUTO-GENERATED from src/data/products.ts by scripts/generate-mcp-catalog.ts.
// Do not edit by hand. Regenerated before every build.

const gradeA = "/assets/grade-a-silica.png";
const gradeADetail = "/assets/grade-a-detail.png";
const gradeB = "/assets/grade-b-silica.png";
...
const sgAntiblocking = "/assets/sg-antiblocking.jpg";
const sgMatting = "/assets/sg-matting.jpg";
const sgLargePore = "/assets/sg-large-pore.jpg";
const sgFng = "/assets/sg-fng.jpg";
const sgCoarse = "/assets/sg-coarse.jpg";
const sgTypeA = "/assets/sg-type-a.jpg";
const sgTypeB = "/assets/sg-type-b.jpg";
const precipitatedSilica = "/assets/precipitated-silica.jpg";
const fumedSilica = "/assets/fumed-silica.png";
const silicaSandImg = "/assets/silica-sand.jpg";
const silicaPowderImg = "/assets/silica-powder.jpg";
const sphericalImg = "/assets/spherical-silica-powder.jpg";
const roundCornerImg = "/assets/round-corner-silica-powder.jpg";
const angularImg = "/assets/angular-silica-powder.jpg";
const lowRadImg = "/assets/low-radiation-silica-powder.jpg";
const surfaceModImg = "/assets/surface-modified-silica-powder.jpg";
const sandGranuleImg = "/assets/silica-sand-granule.jpg";
const leadFreeGlassImg = "/assets/lead-free-glass-powder.jpg";
const hf04Img = "/assets/hf04-fused-silica-powder.jpg";
const sphSemImg = "/assets/sl-sph-300-sem.png";
const slFpo10Img = "/assets/sl-fpo10-fused-silica.jpg";
...
const hgmImg = "/assets/hollow-glass-microspheres.jpg";
...
export const productCatalog: ProductDetail[] = [
  ...
  },
  {
    slug: "sls-series",
    name: "SN-S 시리즈 규사",
    enName: "SN-S Series Silica Sand", jaName: "SN-Sシリーズ 珪砂",
    tagline: "고순도 SiO₂·저철·고백색 — 선별·세척·산처리 공정의 산업용 규사 (SN-S 표준 시리즈)",
    enTagline: "High-Purity SiO₂, Low Iron, High Whiteness — Industrial Silica Sand (SN-S Standard Series)",
    jaTagline: "高純度SiO₂・低鉄・高白色度 — 選別・洗浄・酸処理工程による産業用シリカサンド(SN-S標準シリーズ)",
    description:
      "SN-S 시리즈는 천연 규석(Quartz)을 원료로 선별, 세척 및 산처리 공정을 거쳐 생산한 고품질 산업용 규사 표준 라인업입니다. 높은 이산화규소(SiO₂) 함량과 낮은 철(Fe) 함량, 우수한 백색도를 갖추고 있으며, 균일한 입도와 뛰어난 화학적 안정성으로 다양한 산업 분야에서 안정적인 품질을 제공합니다.",
    enDescription:
      "The SN-S Series is a high-quality industrial silica sand lineup produced from natural quartz through screening, washing, and acid-treatment processes. With high silicon dioxide (SiO₂) content, low iron (Fe) content, and excellent whiteness, it delivers consistent quality across a wide range of industries thanks to its uniform grain size and outstanding chemical stability.",
    jaDescription:
      "SN-Sシリーズは、天然石英(Quartz)を原料に選別・洗浄および酸処理工程を経て生産する高品質な産業用シリカサンド標準ラインアップです。高い二酸化ケイ素(SiO₂)含有量と低い鉄(Fe)含有量、優れた白色度を備えており、均一な粒度と優れた化学的安定性により、多様な産業分野で安定した品質を提供します。",
    image: silicaSandImg,
    category: "sand",
    features: [
  ...
  },
  {
    ...
    name: "SN-P 시리즈 규사분말",
    enName: "SN-P Series Silica Powder", jaName: "SN-Pシリーズ 珪砂粉末 (シリカパウダー)",
...
// —— 실리카겔 라인업 (신규 SN-CHR/IND/DES/ALS + 기존 6종) ——
...
const silicaGelProducts: ProductDetail[] = [
  ...
  // ===== 신규 SN-CHR : 크로마토그래피용 =====
  mkSG("silica-gel-sl-chr-01", "SN-CHR-01 컬럼크로마토그래피용 실리카겔 (A/B/C형)",
    "SN-CHR-01 · Column Chromatography Silica Gel (Type A/B/C)",
    "SN-CHR-01 カラムクロマトグラフィー用シリカゲル (A/B/C型)",
    ...
    "SN-CHR-01은 백색의 균일한 과립형 컬럼크로마토그래피 전용 실리카겔로, 세공형(A, 20–30Å)·중공형(B, 50–80Å)·조공형(C, 90–100Å) 3종 공극 구조를 지원합니다. 성분별 흡착 보유시간 차이를 이용해 중약재 유효성분 분리정제, 석유제품 정제, 유기가스·액체의 선택적 흡착분리, 촉매담체 등에 사용됩니다. 입도 60–400목 범위에서 맞춤 공급 가능합니다.",
    "SN-CHR-01 is a white uniform granular silica gel for column chromatography, supporting three pore structures — fine (A, 20–30Å), medium (B, 50–80Å) and coarse (C, 90–100Å). It is used for purifying active ingredients in traditional Chinese medicine, refining petroleum products, selective adsorption of organic gases/liquids and catalyst supports. Available in 60–400 mesh custom sizes.",
    "SN-CHR-01は白色均一顆粒状のカラムクロマトグラフィー専用シリカゲルで、細孔(A, 20–30Å)・中孔(B, 50–80Å)・粗孔(C, 90–100Å)の3種細孔構造をサポートします。生薬有効成分の分離精製、石油製品精製、有機ガス・液体の選択吸着分離、触媒担体に使用されます。",
    slChr01Img,
    [
  ...
  mkSG("silica-gel-sl-chr-02", "SN-CHR-02 박막크로마토그래피용 실리카겔 (분말)",
    "SN-CHR-02 · Thin Layer Chromatography Silica Gel (Powder)",
    "SN-CHR-02 薄層クロマトグラフィー用シリカゲル (粉末)",
    "H / HF254 / G / GF254 4형 · 신속 고감도 분석시약",
    "H / HF254 / G / GF254 4 types for rapid high-sensitivity analysis",
    "H / HF254 / G / GF254 4型 · 迅速・高感度分析試薬",
    "SN-CHR-02는 백색 분말로 물·유기용매에 불용인 TLC 전용 실리카겔입니다. H·HF254·G·GF254 4형 공급이며, 의약·농약·염료·고무 컬럼분석용 신속·고감도 분석시약, 석유제품 정제, 액체 선택적 흡착분리, 촉매담체 제조 등에 사용됩니다. 일반 입도 10–40㎛, 고효율 5–10㎛/3–10㎛로 맞춤 가능합니다.",
    "SN-CHR-02 is a white TLC silica gel powder insoluble in water and organic solvents. Supplied in H, HF254, G and GF254 types for pharmaceutical, agrochemical, dye and rubber column analysis, petroleum refining, selective adsorption and catalyst supports. General 10–40 µm, high-efficiency 5–10 µm / 3–10 µm.",
    "SN-CHR-02は白色粉末で水・有機溶媒に不溶のTLC専用シリカゲルです。H・HF254・G・GF254の4型を供給し、医薬・農薬・染料・ゴムのカラム分析用試薬、石油製品精製、選択吸着分離、触媒担体などに使用されます。",
    slChr02Img,
    [
  ...
  mkSG("silica-gel-sl-chr-03", "SN-CHR-03 TLC 박막크로마토그래피 플레이트",
    "SN-CHR-03 · TLC Silica Gel Plate",
    "SN-CHR-03 TLCシリカゲルプレート",
    ...
    "SN-CHR-03은 고순도 TLC 실리카겔 분말에 소량의 결합제를 배합해 판상으로 제작한 박막크로마토그래피 플레이트입니다. 표면이 순백색이며 평탄·균일·치밀하고, 의약품·농약·중약재·유기화학·식품의 정성/정량 분석에 광범위하게 사용됩니다. 일반 TLC 실리카겔 대비 분리효과가 우수합니다.",
    "SN-CHR-03 is a TLC plate made by blending high-purity TLC silica gel powder with a small amount of binder. The pure white, flat, uniform and dense surface delivers superior separation vs bulk TLC gel and is widely used for QC analysis of pharmaceuticals, agrochemicals, herbal medicines, organic chemistry and food.",
    "SN-CHR-03は高純度TLCシリカゲル粉末に少量のバインダーを配合し板状に加工した薄層クロマトグラフィープレートです。純白・平坦・均一・緻密な表面で分離効果が優れ、医薬品・農薬・生薬・有機化学・食品の定性/定量分析に幅広く使用されます。",
    slChr03Img,
    [
  ...
  // ===== SN-IND : 산업·공정용 =====
  mkSG("silica-gel-sl-ind-01", "SN-IND-01 촉매용 미분 실리카겔 (C형)",
    "SN-IND-01 · Micro-powder Silica Gel for Catalyst (Type C)",
    "SN-IND-01 触媒用微粉シリカゲル (C型)",
    "SiO₂ ≥ 98 % · HZSM-5 분자체 합성 전용",
    "SiO₂ ≥ 98 % — for HZSM-5 molecular sieve synthesis",
    "SiO₂ ≥ 98 % · HZSM-5分子篩合成専用",
    "SN-IND-01은 고품질 실리카겔 원료로 가공된 촉매 합성 전용 미분 실리카겔입니다. 순도가 높고 불순물(특히 중금속) 함량이 적으며 입도가 균일해 HZSM-5 분자체 합성에 최적입니다.",
    "SN-IND-01 is a micro-powder silica gel processed from high-quality raw material for catalyst synthesis. High purity, ultra-low heavy-metal impurities and uniform particle size make it ideal for HZSM-5 molecular sieve synthesis.",
    "SN-IND-01は高品質シリカゲル原料から加工された触媒合成専用の微粉シリカゲルです。高純度・低不純物(特に重金属)・均一粒度でHZSM-5分子篩合成に最適です。",
    slInd01Img,
    [
      { label: "공경", value: "90–100 Å", enLabel: "Pore", jaLabel: "細孔径" },
      { label: "비표면적", value: "320–400 m²/g", enLabel: "SSA", jaLabel: "比表面積" },
  ...
  mkSG("silica-gel-sl-ind-02", "SN-IND-02 유로키나제 흡착용 실리카겔 (C형)",
    "SN-IND-02 · Urokinase Adsorbent Silica Gel (Type C)",
    "SN-IND-02 ウロキナーゼ吸着用シリカゲル (C型)",
    "흡착량(RH100) ≥ 90 % · 유로키나제 정제 전용",
    "≥90% adsorption (RH100) — dedicated to urokinase purification",
    "吸着量(RH100) ≥ 90 % · ウロキナーゼ精製専用",
    "SN-IND-02는 유로키나제 분자구조에 최적화된 비표면적·공극구조 및 활성 컬럼크로마토그래피 특성을 지닌 백색 균일 과립 실리카겔입니다. 유로키나제 분리정제 목적 달성과 동시에 제품 품질·수율을 향상시킵니다.",
    "SN-IND-02 is a white uniform granular silica gel with SSA, pore structure and active column-chromatography characteristics optimized for urokinase. Delivers separation/purification while improving product quality and yield.",
    "SN-IND-02はウロキナーゼの分子構造に最適化された比表面積・細孔構造とアクティブカラムクロマト特性を持つ白色均一顆粒シリカゲルです。分離精製と同時に品質・収率を向上させます。",
    slInd02Img,
    [
      { label: "공경", value: "90–100 Å", enLabel: "Pore", jaLabel: "細孔径" },
  ...
  mkSG("silica-gel-sl-ind-03", "SN-IND-03 맥주 여과용 실리카겔 (초광공형)",
    "SN-IND-03 · Silica Gel for Beer (Super Wide Pore)",
    "SN-IND-03 ビール濾過用シリカゲル (超広孔型)",
    ...
    "SN-IND-03은 공경 8–16 nm의 비결정질 미세다공성 고체분말로, 산·알칼리·염류와 반응하지 않고 무독·무취·불연성입니다. 넓은 비표면적과 미세공극구조로 맥주 혼탁 유발 단백질을 수 분 내 흡착 제거하여 저장기간을 180–240일 연장하고 냉장 혼탁을 방지하며, 맥주 거품·맛에는 영향을 주지 않습니다.",
    "SN-IND-03 is an amorphous micro-porous solid powder (8–16 nm pores), non-reactive with acids/alkalis/salts, non-toxic, odorless and non-flammable. Its high SSA and micro-pore structure adsorb haze-forming proteins in minutes, extending beer shelf life 180–240 days and preventing chill haze without affecting foam or taste.",
    "SN-IND-03は細孔径8–16 nmの非晶質微多孔性固体粉末で、酸・アルカリ・塩と反応せず無毒・無臭・不燃です。ビール混濁の原因タンパクを短時間で吸着除去し保存期間を180–240日延長、冷蔵混濁を防止しつつ泡・味に影響を与えません。",
    slInd03Img,
    [
  ...
  mkSG("silica-gel-sl-ind-04", "SN-IND-04 대공극 실리카겔 (C형, 구형/괴상)",
    "SN-IND-04 · Wide Pore Silica Gel (Type C)",
    "SN-IND-04 大孔径シリカゲル (C型, 球/塊状)",
    "공기가스 탈수정제 · 절연유 정제 · 촉매담체",
    "Industrial gas dehydration · insulating oil refining · catalyst support",
    "工業ガス脱水精製 · 絶縁油精製 · 触媒担体",
    "SN-IND-04는 백색 괴상 또는 구형의 대공극 실리카겔로, 방습포장, 공업가스 탈수정제, 절연유 내 유기산·고분자물질 제거, 공업 발효공정의 이분자단백 흡착, 촉매 및 촉매담체 등에 사용됩니다.",
    "SN-IND-04 is a wide-pore silica gel in white lump or bead form, used for moisture-proof packaging, industrial gas dehydration, removal of organic acids/polymers in insulating oil, protein adsorption in fermentation, and as a catalyst/carrier.",
    "SN-IND-04は白色塊状または球状の大孔径シリカゲルで、防湿包装、工業ガスの脱水精製、絶縁油中の有機酸/高分子物質除去、工業発酵工程での二分子タンパク吸着、触媒・担体などに使用されます。",
    slInd04Img,
    [
  ...
  mkSG("silica-gel-sl-ind-05", "SN-IND-05 오일 탈색용 실리카겔 샌드 (C형)",
    "SN-IND-05 · Silica Gel Sand for Oil Bleaching (Type C)",
    "SN-IND-05 オイル脱色用シリカゲルサンド (C型)",
    ...
    "SN-IND-05는 백색 과립 형태의 실리카겔로, 전통적인 산·알칼리·백토 탈색공정을 여과 방식으로 대체하여 오일 중 불순물·산화물을 직접 제거함으로써 흑변 오일을 투명한 액체로 전환합니다. 흑취 경유 탈취·탈색, 폐엔진오일 재생, 유압유·바이오디젤·동식물유 탈색·정제·탈취에 사용됩니다.",
    "SN-IND-05 is a white granular silica gel replacing traditional acid/alkali/clay bleaching with filtration to remove impurities and oxidation products, restoring blackened oils to a clear state. Used for diesel deodorization, waste engine oil regeneration, hydraulic oil, biodiesel and animal/vegetable oil refining.",
    "SN-IND-05は白色顆粒状のシリカゲルで、従来の酸・アルカリ・白土脱色工程を濾過方式に置き換え、オイル中の不純物・酸化物を除去して黒変オイルを透明液体に転換します。ディーゼル脱臭、廃エンジンオイル再生、油圧油・バイオディーゼル・動植物油の精製に使用されます。",
    slInd05Img,
    [
  ...
  mkSG("silica-gel-sl-ind-06", "SN-IND-06 대공극 마이크로구형 실리카겔 (C형)",
    "SN-IND-06 · Macro-pored Micro-spherical Silica Gel (Type C)",
    "SN-IND-06 大孔径マイクロ球状シリカゲル (C型)",
    "고열안정성·고기계강도의 촉매·촉매담체",
    "High thermal stability & mechanical strength catalyst / support",
    "高熱安定性・高機械強度の触媒/担体",
    "SN-IND-06은 백색 투명/반투명의 마이크로 구형 실리카겔로, 균일한 미세공극구조와 안정적인 물리·화학적 특성, 우수한 열안정성과 높은 기계적 강도를 지닙니다. 멜라민·아닐린·아세트산비닐·부타디엔고무·아크릴로니트릴 등 중요 공업생산 촉매·촉매담체, 방향족 정제, 의약품 정제, 유기가스·액체 선택적 흡착분리, 수중 유해 이온 제거에 활용됩니다.",
    "SN-IND-06 is a translucent micro-spherical silica gel with uniform micro-pores, stable properties, excellent thermal stability and high mechanical strength. Used as catalyst/support for melamine, aniline, vinyl acetate, butadiene rubber, acrylonitrile production; aromatics/pharmaceutical purification; selective adsorption; ion exchange in water treatment.",
    "SN-IND-06は白色透明/半透明のマイクロ球状シリカゲルで、均一微細細孔・優れた熱安定性・高い機械強度を有します。メラミン・アニリン・酢酸ビニル・ブタジエンゴム・アクリロニトリル生産の触媒/担体、芳香族精製、医薬品精製、選択吸着分離、水中イオン除去などに活用されます。",
    slInd06Img,
    [
  ...
  mkSG("silica-gel-sl-ind-07", "SN-IND-07 폐엔진오일 정제용 촉매",
    "SN-IND-07 · Catalyst for Waste Engine Oil Refining",
    "SN-IND-07 廃エンジンオイル精製用触媒",
    "반응온도 290–310℃ · 압쇄강도 ≥ 125–130 N/cm",
    "290–310℃ reaction · crush strength ≥ 125–130 N/cm",
    "反応温度290–310℃ · 圧潰強度 ≥ 125–130 N/cm",
    "SN-IND-07은 폐엔진오일(폐윤활유) 정제 전용 신형 촉매입니다. 반응온도 290–310℃, 공간속도 0.2–0.25 h⁻¹, 상압 조건에서 사용하며, 정기적으로 촉매 건조 공정(0–0.1 MPa, 300–360℃, 6–8시간)이 필요합니다. 산·알칼리와의 접촉을 피해야 하며, 사용 전 30목 체망으로 촉매 분진을 제거해야 합니다.",
    "SN-IND-07 is a new catalyst dedicated to refining waste engine oil. Operates at 290–310℃, LHSV 0.2–0.25 h⁻¹, atmospheric pressure. Periodic drying (0–0.1 MPa, 300–360℃, 6–8h) required. Avoid acid/alkali contact and screen out dust with 30-mesh sieve before use.",
    "SN-IND-07は廃エンジンオイル(廃潤滑油)精製専用の新型触媒です。反応温度290–310℃、LHSV 0.2–0.25 h⁻¹、常圧で使用し、定期的な乾燥工程(0–0.1 MPa, 300–360℃, 6–8時間)が必要です。",
    slInd07Img,
    [
  ...
  // ===== SN-DES : 건조제·흡습제 =====
  mkSG("silica-gel-sl-des-01", "SN-DES-01 세공형 실리카겔 (A형)",
    "SN-DES-01 · Fine-pored Silica Gel (Type A)",
    "SN-DES-01 細孔型シリカゲル (A型)",
    "비표면적 650–800 m²/g · 건조·방습 표준품",
    "SSA 650–800 m²/g — standard desiccant grade",
    "比表面積650–800 m²/g · 乾燥・防湿標準品",
    "SN-DES-01은 투명 또는 반투명 유리질의 구형(펠릿) 또는 괴상 실리카겔입니다. 평균 공경 2.0–3.0 nm, 비표면적 650–800 m²/g로 건조·방습이 주된 용도이며, 촉매담체·흡착제·분리제·변압흡착(PSA) 용도로도 사용됩니다.",
    "SN-DES-01 is a transparent/translucent glass-like silica gel in pellet or lump form. Average pore 2.0–3.0 nm and SSA 650–800 m²/g make it a standard desiccant, also used for catalyst supports, adsorbents, separators and PSA.",
    "SN-DES-01は透明または半透明ガラス質の球形(ペレット)/塊状シリカゲルです。平均細孔2.0–3.0 nm、比表面積650–800 m²/gで乾燥・防湿が主用途、触媒担体・吸着剤・分離剤・PSAにも使用されます。",
    slDes01Img,
    [
  ...
  mkSG("silica-gel-sl-des-02", "SN-DES-02 변압흡착(PSA)용 실리카겔 (A형)",
    "SN-DES-02 · Pressure Swing Adsorption (PSA) Silica Gel (Type A)",
    "SN-DES-02 圧力スイング吸着(PSA)用シリカゲル (A型)",
    "CO₂ 흡착량 ≥ 20 cm³/g · 압축강도 ≥ 100 N",
    "CO₂ ≥ 20 cm³/g · crush ≥ 100 N",
    "CO₂吸着量 ≥ 20 cm³/g · 圧縮強度 ≥ 100 N",
    "SN-DES-02는 투명/반투명 유리질 세공 구형 실리카겔로, 변압흡착(PSA) 방식의 기체 분리·정제용 첨단 소재입니다. 이산화탄소 회수·분리·정제에 주로 사용되며 합성암모니아공업·식품음료가공업의 이산화탄소 제조, 건조·방습, 유기제품 탈수 정제에도 사용됩니다.",
    "SN-DES-02 is a transparent/translucent glass-like fine-pored spherical silica gel for pressure swing adsorption (PSA). Primarily used for CO₂ recovery/purification, ammonia synthesis, food & beverage CO₂ production, drying and organic dehydration.",
    "SN-DES-02は透明/半透明ガラス質細孔球状シリカゲルで、圧力スイング吸着(PSA)による気体分離・精製用の先端素材です。",
    slDes02Img,
    [
  ...
  mkSG("silica-gel-sl-des-03", "SN-DES-03 블루 실리카겔 (A형, 습도지시)",
    "SN-DES-03 · Blue Silica Gel (Type A, Humidity Indicator)",
    "SN-DES-03 ブルーシリカゲル (A型, 湿度指示)",
    "청색 → 분홍색 · 상대습도 직관 표시",
    "Blue → pink — visual RH indicator",
    "青 → ピンク · 相対湿度を視覚表示",
    "SN-DES-03은 청색 또는 담청색 유리상 과립(구형/괴상) 실리카겔입니다. 습기 흡수 후 청색에서 분홍색으로 변색되어 상대습도를 직관적으로 표시합니다. 정밀기기·의약품·석유화학·식품·의류·가전·항공·군수 등 밀폐 환경의 방청·방습 및 습도 지시에 광범위하게 사용됩니다.",
    "SN-DES-03 is a blue/light-blue glass-like granular silica gel (bead/lump). Absorbs moisture and turns pink to visually indicate relative humidity — widely used for rust/moisture protection and humidity indication in precision instruments, pharmaceuticals, petrochemicals, food, garments, appliances, aviation and defense.",
    "SN-DES-03は青色または淡青色ガラス状顆粒(球/塊)のシリカゲルです。吸湿後に青→ピンクへ変色し相対湿度を視覚表示、精密機器・医薬品・石油化学・食品・衣料・家電・航空・軍需などの密閉環境の防錆・防湿および湿度指示に幅広く使用されます。",
    slDes03Img,
    [
  ...
  mkSG("silica-gel-sl-des-04", "SN-DES-04 오렌지 실리카겔 (A형, 습도지시)",
    "SN-DES-04 · Orange Silica Gel (Type A, Humidity Indicator)",
    "SN-DES-04 オレンジシリカゲル (A型, 湿度指示)",
    "무코발트 친환경 습도지시 실리카겔",
    "Cobalt-free eco-friendly humidity indicator silica gel",
    "無コバルト・環境配慮型 湿度指示シリカゲル",
    "SN-DES-04는 보라색·귤색·황색 3가지 유형의 구형/불규칙 과립 실리카겔로, 코발트클로라이드를 함유하지 않아 무독·무해합니다. 습도에 따라 색상이 변화해 습도 지시 기능을 제공하며, 블루 실리카겔과 동일한 산업분야(정밀기기·의약·석유화학·식품·의류·가전·항공·군수 등)에 사용됩니다.",
    "SN-DES-04 comes in three variants (purple, orange, yellow) as spherical/irregular granules, cobalt-chloride-free and non-toxic. Changes color with humidity for RH indication, used in the same fields as blue silica gel (precision instruments, pharma, petrochem, food, garments, appliances, aviation, defense).",
    "SN-DES-04は紫・橙・黄の3タイプの球形/不定形顆粒シリカゲルで、塩化コバルトを含まず無毒・無害です。湿度に応じて変色し湿度指示機能を提供、ブルーシリカゲルと同じ産業分野で使用されます。",
    slDes04Img,
    [
  ...
  mkSG("silica-gel-sl-des-05", "SN-DES-05 B형 실리카겔",
    "SN-DES-05 · B Type Silica Gel",
    "SN-DES-05 B型シリカゲル",
    "평균 공경 5–8 nm · 공기습도조절·촉매담체·향료",
    "5–8 nm avg pore — humidity control, catalyst support, fragrance",
    "平均細孔5–8 nm · 湿度調整・触媒担体・香料",
    "SN-DES-05는 구형 또는 괴상, 투명/반투명 유리상의 B형 실리카겔입니다. 평균 공경 5.0–8.0 nm, 비표면적 450–600 m²/g로 공기습도조절제, 촉매 및 촉매담체, 향료 실리카겔·반려동물 깔개 재료, 컬럼크로마토그래피 실리카겔 등 정밀화학 원료로 사용됩니다.",
    "SN-DES-05 is a B-type silica gel in spherical/lump form (transparent/translucent). Avg pore 5.0–8.0 nm, SSA 450–600 m²/g — used as humidity regulator, catalyst support, fragrance carrier, pet litter and column chromatography feedstock.",
    "SN-DES-05は球形/塊状、透明/半透明ガラス状のB型シリカゲルです。平均細孔5.0–8.0 nm、比表面積450–600 m²/gで湿度調整剤、触媒/担体、香料キャリア、ペットリッター、カラムクロマト原料などに使用されます。",
    slDes05Img,
    [
  ...
  mkSG("silica-gel-sl-des-06", "SN-DES-06 실리카겔 고양이모래 (C형)",
    "SN-DES-06 · Silica Gel Cat Litter (Type C)",
    "SN-DES-06 シリカゲル猫砂 (C型)",
    "크리스탈 고양이모래 · 경량·저파쇄·항균",
    "Crystal cat litter — lightweight, low crush, antibacterial",
    "クリスタル猫砂 · 軽量・低破砕・抗菌",
    "SN-DES-06은 반려동물 배설물의 수분·냄새를 흡수하고 건조 상태를 유지하며 세균 번식을 억제하는 크리스탈 고양이모래입니다. 벤토나이트 등 기존 고양이모래 대비 경량·저파쇄율·무독·무오염의 친환경 제품으로, 흰색/청색/컬러 과립 커스터마이즈가 가능합니다.",
    "SN-DES-06 is crystal cat litter that absorbs pet waste moisture and odor while keeping surfaces dry and suppressing bacteria. Lighter, less crushable, non-toxic and non-polluting vs bentonite litter — customizable in white/blue/color granules.",
    "SN-DES-06はペットの排泄物の水分・臭いを吸収し乾燥状態を保ち、菌の繁殖を抑制するクリスタル猫砂です。ベントナイト等の従来品より軽量・低破砕率・無毒・無汚染で、白/青/カラー顆粒のカスタマイズが可能です。",
    slDes06Img,
    [
      { label: "공경", value: "80–100 Å", enLabel: "Pore", jaLabel: "細孔径" },
      { label: "비표면적", value: "300–400 m²/g", enLabel: "SSA", jaLabel: "比表面積" },
  ...
  mkSG("silica-gel-sl-des-07", "SN-DES-07 FNG 내수성 실리카겔",
    "SN-DES-07 · FNG Water-Resistant Silica Gel",
    "SN-DES-07 FNG耐水性シリカゲル",
    ...
    "SN-DES-07은 백색 또는 회백색 과립의 FNG형 내수성 실리카겔로, 일반 실리카겔과 동일한 공극구조·흡착 특성을 지니면서도 내수성이 우수해 물에 젖어도 파열되지 않고 사용수명이 깁니다. 압축공기 건조정화, 아세틸렌·이산화탄소 흡착제, 석유화학·전력·양조업 액체 흡착제 및 촉매담체, 일반 실리카겔의 보호층 완충 건조제로 사용됩니다.",
    "SN-DES-07 is a white/off-white FNG water-resistant silica gel. It retains the pore structure and adsorption of standard silica gel but resists cracking when wet for longer service life. Used for compressed-air drying, acetylene/CO₂ adsorption, liquid adsorption in petrochemicals/power/brewing, and as protective buffer for standard silica gel.",
    "SN-DES-07は白色または灰白色のFNG耐水性シリカゲルで、通常シリカゲルの細孔構造・吸着特性を保ちつつ耐水性に優れ、水に濡れても破裂せず長寿命です。",
    slDes07Img,
    [
  ...
  // ===== SN-ALS : 알루미나·분자체 (실리카졸은 별도 카테고리) =====
  mkSG("silica-gel-sl-als-01", "SN-ALS-01 실리카알루미나겔",
    "SN-ALS-01 · Silica Alumina Gel",
    "SN-ALS-01 シリカアルミナゲル",
    ...
    "SN-ALS-01은 화학식 mSiO₂·nAl₂O₃·xH₂O의 실리카알루미나겔로, 화학적으로 안정하고 불연성이며 강알칼리·불화수소산 외 용매에 불용입니다. 세공형 실리카겔보다 강한 표면 극성과 우수한 흡착분리성능, 뛰어난 열안정성을 지녀 압축천연가스·천연가스·기체·액화가스 건조 등에 광범위하게 사용됩니다.",
    "SN-ALS-01 is a silica alumina gel (mSiO₂·nAl₂O₃·xH₂O). Chemically stable, non-flammable and insoluble in solvents except strong alkali and hydrofluoric acid. Stronger surface polarity and superior adsorption/thermal stability vs fine-pored silica gel — widely used for CNG, natural gas, gaseous and liquefied gas drying.",
    "SN-ALS-01は化学式mSiO₂·nAl₂O₃·xH₂Oのシリカアルミナゲルで、化学的に安定・不燃性、強アルカリ・フッ化水素酸以外の溶媒に不溶です。細孔型シリカゲルより強い表面極性と優れた吸着分離性能・熱安定性を持ち、CNG・天然ガス・気体・液化ガス乾燥などに広く使用されます。",
    slAls01Img,
    [
  ...
  mkSG("silica-gel-sl-als-03", "SN-ALS-03 활성알루미나볼",
    "SN-ALS-03 · Activated Alumina Ball",
    "SN-ALS-03 活性アルミナボール",
    "Al₂O₃ ≥ 92 % · 비가열재생 건조제 · 175–315℃ 재생",
    "Al₂O₃ ≥ 92 % — non-heat-regenerative desiccant, 175–315℃ regeneration",
    "Al₂O₃ ≥ 92 % · 非加熱再生型乾燥剤 · 175–315℃再生",
    "SN-ALS-03은 백색 구형의 다공성 활성알루미나 흡착재입니다. 입도가 균일하고 표면이 매끄러우며 기계적 강도가 높고 흡습력이 강하며, 흡습 후에도 팽창·균열 없이 원형을 유지합니다. 무독·무취·물과 에탄올에 불용이며, 기체·수증기 및 일부 액체 속 수분을 선택적으로 흡착하고 175–315℃ 가열로 재생 가능한 고효율 건조제입니다.",
    "SN-ALS-03 is a white spherical porous activated alumina adsorbent. Uniform particle size, smooth surface, high mechanical strength and strong moisture absorption without swelling/cracking. Non-toxic, odorless, insoluble in water/ethanol — a high-efficiency desiccant that selectively adsorbs water from gases, vapors and some liquids and regenerates at 175–315℃.",
    "SN-ALS-03は白色球状の多孔性活性アルミナ吸着材です。均一粒度、滑らかな表面、高い機械強度、強い吸湿力を持ち、吸湿後も膨張・亀裂なく原形を維持します。",
    slAls03Img,
    [
      { label: "Al₂O₃", value: "≥ 92 %" },
  ...
  mkSG("silica-gel-sl-als-04", "SN-ALS-04 분자체 (4A)",
    "SN-ALS-04 · Molecular Sieve (4A)",
    "SN-ALS-04 分子篩 (4A)",
    ...
    "SN-ALS-04는 공경 4Å의 4A 분자체로, 물·메탄올·에탄올·황화수소·이산화황·이산화탄소·에틸렌·프로필렌을 흡착하며 직경 4Å을 초과하는 분자(프로판 포함)는 흡착하지 않습니다. 물에 대한 선택적 흡착성이 가장 높아 산업용 분자체 중 사용량이 가장 많으며, 천연가스·냉매 등 기체·액체 심층건조, 아르곤 생산정제, 의약품·전자부품 정적건조, 도료·연료·코팅제 탈수제에 사용됩니다.",
    "SN-ALS-04 is a 4Å (4A) molecular sieve that adsorbs water, methanol, ethanol, H₂S, SO₂, CO₂, ethylene and propylene while excluding molecules > 4Å (incl. propane). Its selectivity for water makes it the most widely used industrial sieve — for deep drying of natural gas/refrigerants, argon production, static drying of pharmaceuticals/electronics and dehydration of paints/fuels/coatings.",
    "SN-ALS-04は細孔径4Åの4A分子篩で、水・メタノール・エタノール・H₂S・SO₂・CO₂・エチレン・プロピレンを吸着し、4Å超の分子(プロパン含む)は吸着しません。水への選択的吸着性が最も高く、産業用分子篩の中で最多使用されます。",
    slAls04Img,
    [
...
const advSeriesProducts: ProductDetail[] = [
  {
    ...
    description:
      "구상 실리카 분말은 화염 용융 공정을 통해 완전한 구(球) 형태로 성형된 고순도 무정형 SiO₂ 분말입니다. 낮은 수지 점도, 우수한 유동성, 낮은 열팽창계수를 바탕으로 반도체 EMC(Epoxy Molding Compound), CCL(Copper Clad Laminate), 언더필, 봉지재 등 첨단 전자 소재의 핵심 필러로 사용됩니다. 일반 구상(SN-QG)과 저방사선(Low-α) 구상(SN-QG-L) 2종 시리즈를 기준으로 고객 맞춤 생산 공급합니다.",
    enDescription:
      "Spherical Silica Powder is a high-purity amorphous SiO₂ powder formed into perfect spheres via a flame-fusion process. Thanks to its low resin viscosity, excellent flowability and low CTE, it is used as a key filler in advanced electronic materials such as semiconductor EMC (Epoxy Molding Compound), CCL, underfill and encapsulants. Supplied in two grades: standard SN-QG and low-alpha SN-QG-L.",
    jaDescription:
      "球状シリカ粉末は火炎溶融工程を経て完全な球形に成形された高純度非晶質SiO₂粉末です。低粘度・優れた流動性・低熱膨張係数により、半導体EMC(エポキシ封止材)・CCL・アンダーフィル・封止材など先端電子素材の主要フィラーとして使用されます。標準品SN-QGおよび低α線グレードSN-QG-Lの2種を供給します。",
    image: sphericalImg,
    ...
    features: [
      ...
      { title: "☢️ 저방사선 등급(SN-QG-L)", desc: "저 방사성 원소 함량 — 첨단 메모리 소프트 에러 방지", enTitle: "☢️ Low-Alpha Grade (SN-QG-L)", jaTitle: "☢️ 低α線グレード(SN-QG-L)", enDesc: "Low radioactive element content — prevents soft errors in advanced memory", jaDesc: "低放射性元素含有量 — 先端メモリのソフトエラーを防止" },
      ...
      { title: "📐 정밀 입도 관리", desc: "D50 0.1 ~ 40 µm 맞춤 공급 (SN-QG), D50 1 ~ 30 µm (SN-QG-L)", enTitle: "📐 Precise PSD Control", jaTitle: "📐 精密な粒度管理", enDesc: "D50 0.1–40 µm (SN-QG) or 1–30 µm (SN-QG-L) customizable", jaDesc: "D50 0.1~40 µm (SN-QG) / 1~30 µm (SN-QG-L) カスタム供給" },
    ],
    specs: [
      ...
      { label: "평균 입도 D50", value: "0.1 ~ 40 µm (SN-QG) / 1 ~ 30 µm (SN-QG-L)", enValue: "0.1–40 µm (SN-QG) / 1–30 µm (SN-QG-L)", jaValue: "0.1~40 µm (SN-QG) / 1~30 µm (SN-QG-L)", enLabel: "Mean Particle Size D50", jaLabel: "平均粒度 D50" },
    ...
    subModels: [
      { code: "SN-QG", slug: "sl-qg", spec: "일반 구상", enSpec: "Standard Spherical", jaSpec: "一般球状", name: "SN-QG 일반 구상 실리카 분말", enName: "SN-QG · Standard Spherical Silica Powder", jaName: "SN-QG 一般球状シリカ粉末" },
      { code: "SN-QG-L", slug: "sl-qg-l", spec: "저방사선(Low-α) 구상", enSpec: "Low-Alpha Spherical", jaSpec: "低α線 球状", name: "SN-QG-L 저방사선 구상 실리카 분말", enName: "SN-QG-L · Low-Alpha Spherical Silica Powder", jaName: "SN-QG-L 低α線球状シリカ粉末" },
      { code: "SN-SPH-300", slug: "sl-sph-300", spec: "화학합성 아미크론급 구상 (D50 0.38µm · SiO₂ 99.98%)", enSpec: "Chemically Synthesized Submicron Spherical (D50 0.38 µm · SiO₂ 99.98%)", jaSpec: "化学合成サブミクロン球状 (D50 0.38µm · SiO₂ 99.98%)", name: "SN-SPH-300 고순도 나노구상실리카", enName: "SN-SPH-300 · Ultra-High-Purity Nano Spherical Silica", jaName: "SN-SPH-300 高純度ナノ球状シリカ" },
      { code: "SN-SPJ-300", slug: "sl-spj-300", spec: "구상화율 98% 구상 (D50 0.3±0.1µm · SiO₂ >99.9%)", enSpec: "98% Spheroidization Submicron Spherical (D50 0.3±0.1 µm · SiO₂ >99.9%)", jaSpec: "球状化率98% サブミクロン球状 (D50 0.3±0.1µm · SiO₂ >99.9%)", name: "SN-SPJ-300 구상 실리카", enName: "SN-SPJ-300 · Submicron Spherical Silica", jaName: "SN-SPJ-300 サブミクロン球状シリカ" },
      { code: "SN-FPO10", slug: "sl-fpo10", spec: "고순도 구상 용융 실리카 (D50 9.96µm · SiO₂ 99.93%)", enSpec: "High-Purity Spherical Fused Silica (D50 9.96 µm · SiO₂ 99.93%)", jaSpec: "高純度球状溶融シリカ (D50 9.96µm · SiO₂ 99.93%)", name: "SN-FPO10 고순도 구상 용융 실리카", enName: "SN-FPO10 · High-Purity Spherical Fused Silica", jaName: "SN-FPO10 高純度球状溶融シリカ" },
    ],
  ...
  },
  {
    ...
    description:
      "모서리 라운드 실리카 분말은 각상 실리카의 모서리를 라운딩(round-corner) 처리하여 구상에 근접한 유동성과 낮은 수지 점도, 우수한 충전성을 갖춘 하이브리드형 필러입니다. 구상 대비 경제성이 우수하며, 결정형 SN-YJG와 용융형 SN-YRG 을 기본으로 고객의 요구를 적용한 맟춤 가공 생산 하여  CCL, 도전성 페이스트, 산업용 코팅, 고내마모 복합재 등에 폭넓게 사용됩니다.",
    enDescription:
      "Round Corner Silica Powder is a hybrid filler produced by rounding the corners of angular silica, delivering near-spherical flow, low resin viscosity, and excellent packing. It offers superior cost-performance compared to fully spherical grades, and is available in crystalline SN-YJG and fused SN-YRG grades — widely used in CCL, conductive pastes, industrial coatings, and high-wear composites.",
    jaDescription:
      "丸角シリカ粉末は角形シリカの角を丸め(round-corner)処理し、球状に近い流動性・低樹脂粘度・優れた充填性を備えたハイブリッド型フィラーです。球状品と比較して経済性に優れ、結晶質SN-YJGおよび溶融質SN-YRGの2種で供給され、CCL・導電性ペースト・産業用コーティング・高耐摩耗複合材などに幅広く使用されます。",
    ...
    features: [
      ...
      { title: "🔧 2종 라인업", desc: "결정형(SN-YJG)·용융형(SN-YRG) 선택 가능", enTitle: "🔧 Two Grade Lineup", jaTitle: "🔧 2種ラインアップ", enDesc: "Choice of crystalline SN-YJG and fused SN-YRG", jaDesc: "結晶質(SN-YJG)・溶融質(SN-YRG)の選択が可能" },
    ...
    specs: [
      ...
      { label: "SiO₂ 순도", value: "98.0 ~ 99.9 % (SN-YJG) / 99.0 ~ 99.95 % (SN-YRG)", enValue: "98.0–99.9 % (SN-YJG) / 99.0–99.95 % (SN-YRG)", jaValue: "98.0~99.9 % (SN-YJG) / 99.0~99.95 % (SN-YRG)", enLabel: "SiO₂ Purity", jaLabel: "SiO₂純度" },
      { label: "형상", value: "모서리 라운드(Round Corner)", enValue: "Round Corner", jaValue: "丸角(Round Corner)", enLabel: "Shape", jaLabel: "形状" },
      { label: "백도 / 모스경도 (SN-YJG)", value: "90 이상 / 7", enValue: "90 Min / 7", jaValue: "90以上 / 7", enLabel: "Whiteness / Mohs (SN-YJG)", jaLabel: "白度 / モース硬度 (SN-YJG)" },
      { label: "팽창계수 / PH (SN-YRG)", value: "0.5×10⁻⁶ / 5 ~ 8", enValue: "0.5×10⁻⁶ / 5–8", jaValue: "0.5×10⁻⁶ / 5~8", enLabel: "Expansion / PH (SN-YRG)", jaLabel: "膨張係数 / PH (SN-YRG)" },
    ...
    isCategoryIndex: true,
    subModels: [
      { code: "SN-YJG", slug: "sl-yjg", spec: "결정형 모서리 라운드", enSpec: "Crystalline Round-Corner", jaSpec: "結晶質 丸角", name: "SN-YJG 결정형 모서리 라운드 실리카 분말", enName: "SN-YJG · Crystalline Round-Corner Silica Powder", jaName: "SN-YJG 結晶質丸角シリカ粉末" },
      { code: "SN-YRG", slug: "sl-yrg", spec: "용융형 모서리 라운드", enSpec: "Fused Round-Corner", jaSpec: "溶融質 丸角", name: "SN-YRG 용융형 모서리 라운드 실리카 분말", enName: "SN-YRG · Fused Round-Corner Silica Powder", jaName: "SN-YRG 溶融質丸角シリカ粉末" },
    ],
  ...
  },
  {
    ...
    description:
      "각상 실리카 분말은 고순도 SiO₂를 정밀 분쇄한 각진 형태의 무기 분체 필러로, 뛰어난 기계적 강도와 내마모성, 우수한 절연 특성을 제공합니다. 용융형(SN-RG)과 결정형(SN-JG) 2종으로 공급되며 EMC, 산업 도료, 접착제, 고무 보강, 인조 대리석, 전기 절연재 등 다양한 산업에서 표준 필러로 사용됩니다.",
    enDescription:
      "Angular Silica Powder is an angular inorganic filler produced by precision milling of high-purity SiO₂. It provides outstanding mechanical strength, wear resistance and excellent insulation. Supplied as fused SN-RG and crystalline SN-JG grades, it is used across broad industries — EMC, industrial coatings, adhesives, rubber reinforcement, engineered stone and electrical insulation.",
    jaDescription:
      "角形シリカ粉末は高純度SiO₂を精密粉砕した角状の無機フィラーで、優れた機械的強度・耐摩耗性・絶縁特性を提供します。溶融質(SN-RG)および結晶質(SN-JG)の2種で供給され、EMC・産業塗料・接着剤・ゴム補強・人造大理石・電気絶縁材など幅広い産業で標準フィラーとして使用されます。",
    image: angularImg,
    category: "advanced-series",
    features: [
      ...
      { title: "🔧 2종 그레이드", desc: "용융형(SN-RG) · 결정형(SN-JG) 선택 가능", enTitle: "🔧 Dual Grade Lineup", jaTitle: "🔧 2種グレード", enDesc: "Choice of fused SN-RG and crystalline SN-JG", jaDesc: "溶融質(SN-RG)・結晶質(SN-JG)の選択が可能" },
    ...
    specs: [
      ...
      { label: "SiO₂ 순도", value: "99.0 ~ 99.95 % (SN-RG) / 98.0 ~ 99.9 % (SN-JG)", enValue: "99.0–99.95 % (SN-RG) / 98.0–99.9 % (SN-JG)", jaValue: "99.0~99.95 % (SN-RG) / 98.0~99.9 % (SN-JG)", enLabel: "SiO₂ Purity", jaLabel: "SiO₂純度" },
      { label: "형상", value: "각상 (Angular)", enValue: "Angular", jaValue: "角形 (Angular)", enLabel: "Shape", jaLabel: "形状" },
      { label: "팽창계수 / PH (SN-RG)", value: "0.5×10⁻⁶ / 5 ~ 8", enValue: "0.5×10⁻⁶ / 5–8", jaValue: "0.5×10⁻⁶ / 5~8", enLabel: "Expansion / PH (SN-RG)", jaLabel: "膨張係数 / PH (SN-RG)" },
      { label: "백도 / 모스경도 (SN-JG)", value: "90 이상 / 7", enValue: "90 Min / 7", jaValue: "90以上 / 7", enLabel: "Whiteness / Mohs (SN-JG)", jaLabel: "白度 / モース硬度 (SN-JG)" },
    ...
    isCategoryIndex: true,
    subModels: [
      { code: "SN-RG", slug: "sl-rg", spec: "용융형 각상", enSpec: "Fused Angular", jaSpec: "溶融質 角形", name: "SN-RG 용융형 각상 실리카 분말", enName: "SN-RG · Fused Angular Silica Powder", jaName: "SN-RG 溶融質角形シリカ粉末" },
      { code: "SN-JG", slug: "sl-jg", spec: "결정형 각상", enSpec: "Crystalline Angular", jaSpec: "結晶質 角形", name: "SN-JG 결정형 각상 실리카 분말", enName: "SN-JG · Crystalline Angular Silica Powder", jaName: "SN-JG 結晶質角形シリカ粉末" },
      { code: "SN-FP10", slug: "sl-fp10", spec: "고순도 각상 용융 실리카 (D50 9.96µm · SiO₂ 99.93%)", enSpec: "High-Purity Angular Fused Silica (D50 9.96 µm · SiO₂ 99.93%)", jaSpec: "高純度角形溶融シリカ (D50 9.96µm · SiO₂ 99.93%)", name: "SN-FP10 고순도 각상 용융 실리카", enName: "SN-FP10 · High-Purity Angular Fused Silica", jaName: "SN-FP10 高純度角形溶融シリカ" },
    ],
  ...
  },
  {
    ...
    description:
      "저방사선 실리카 분말은 우라늄(U)·토륨(Th) 등 방사성 불순물을 극한까지 제거하여 α선 방사량을 0.001 cph/cm² 이하로 관리한 초고순도 SiO₂ 필러입니다. HBM, DDR5, 어드밴스드 패키징 등 소프트 에러에 극도로 민감한 첨단 메모리 반도체 EMC·언더필의 필수 소재이며, 결정형(SN-CL)과 용융형(SN-FL) 을 기본으로 하여 상세 맞춤 가공 공급 합니다.",
    enDescription:
      "Low-Alpha Silica Powder is an ultra-high-purity SiO₂ filler in which radioactive impurities (U, Th) have been reduced to the ultimate level, keeping α-emission ≤ 0.001 cph/cm². It is an essential material for EMC and underfill of soft-error-sensitive advanced memory devices such as HBM, DDR5 and advanced packaging. Supplied as crystalline SN-CL and fused SN-FL grades.",
    jaDescription:
      "低α線シリカ粉末は、ウラン(U)・トリウム(Th)などの放射性不純物を極限まで除去し、α線放射量を0.001 cph/cm²以下に管理した超高純度SiO₂フィラーです。HBM・DDR5・アドバンストパッケージングなどソフトエラーに極めて敏感な先端メモリ半導体のEMC・アンダーフィルの必須素材で、結晶質(SN-CL)・溶融質(SN-FL)の2種で供給されます。",
    image: lowRadImg,
    category: "advanced-series",
    features: [
      ...
      { title: "🔧 2종 그레이드", desc: "결정형(SN-CL) · 용융형(SN-FL) 선택 가능", enTitle: "🔧 Dual Grade", jaTitle: "🔧 2種グレード", enDesc: "Crystalline SN-CL and fused SN-FL grades available", jaDesc: "結晶質(SN-CL)・溶融質(SN-FL)の選択が可能" },
      { title: "🧪 고순도 SiO₂", desc: "98.0 ~ 99.95 % (SN-CL 결정형 / SN-FL 용융형)", enTitle: "🧪 High-Purity SiO₂", jaTitle: "🧪 高純度SiO₂", enDesc: "98.0–99.95 % (SN-CL crystalline / SN-FL fused)", jaDesc: "98.0~99.95 % (SN-CL 結晶質 / SN-FL 溶融質)" },
    ...
    specs: [
      ...
      { label: "SiO₂ 순도", value: "98.0 ~ 99.9 % (SN-CL) / 99.0 ~ 99.95 % (SN-FL)", enValue: "98.0–99.9 % (SN-CL) / 99.0–99.95 % (SN-FL)", jaValue: "98.0~99.9 % (SN-CL) / 99.0~99.95 % (SN-FL)", enLabel: "SiO₂ Purity", jaLabel: "SiO₂純度" },
      { label: "백도 / 모스경도 (SN-CL)", value: "90 이상 / 7", enValue: "90 Min / 7", jaValue: "90以上 / 7", enLabel: "Whiteness / Mohs (SN-CL)", jaLabel: "白度 / モース硬度 (SN-CL)" },
      { label: "백도 / PH (SN-FL)", value: "90 이상 / 5 ~ 8", enValue: "90 Min / 5–8", jaValue: "90以上 / 5~8", enLabel: "Whiteness / PH (SN-FL)", jaLabel: "白度 / PH (SN-FL)" },
    ...
    isCategoryIndex: true,
    subModels: [
      { code: "SN-CL", slug: "sl-cl", spec: "저방사선 결정형", enSpec: "Low-Alpha Crystalline", jaSpec: "低α線 結晶質", name: "SN-CL 저방사선 결정형 실리카 분말", enName: "SN-CL · Low-Alpha Crystalline Silica Powder", jaName: "SN-CL 低α線結晶質シリカ粉末" },
      { code: "SN-FL", slug: "sl-fl", spec: "저방사선 용융형", enSpec: "Low-Alpha Fused", jaSpec: "低α線 溶融質", name: "SN-FL 저방사선 용융형 실리카 분말", enName: "SN-FL · Low-Alpha Fused Silica Powder", jaName: "SN-FL 低α線溶融質シリカ粉末" },
    ],
  ...
  },
  {
    ...
    description:
      "표면개질 실리카 분말은 SiO₂ 표면에 실란 커플링제(에폭시 실란 등)를 화학적으로 결합시켜 수지와의 친화성, 분산성, 계면 접착력을 획기적으로 향상시킨 기능성 필러입니다. 활성 결정질 실리카와 활성 용융 실리카를 기준으로 표준모델 SN-HJG와 SN-HRG를 기준으로 입도와 순도 등은 고객사의 요구에 대응하는 등급으로 공급되며, 반도체 EMC·언더필, 에폭시·페놀·실리콘·아크릴 등 다양한 수지 매트릭스에 최적화됩니다.",
    enDescription:
      "Surface-Modified Silica Powder is a functional filler in which epoxy-silane coupling agent is chemically bonded to the SiO₂ surface, dramatically improving resin compatibility, dispersion and interfacial adhesion. Based on active crystalline silica and active fused silica, with standard models SN-HJG and SN-HRG as the baseline, grades matching particle size, purity and other requirements are supplied to meet customer needs — optimized for semiconductor EMC/underfill and epoxy, phenolic, silicone and acrylic resin matrices.",
    jaDescription:
      "表面改質シリカ粉末は、SiO₂表面にシランカップリング剤(エポキシシラン)を化学結合させ、樹脂との親和性・分散性・界面接着力を飛躍的に向上させた機能性フィラーです。活性結晶質シリカと活性溶融シリカを基準とし、標準モデルSN-HJG・SN-HRGを基準に粒度や純度などは顧客の要求に応じたグレードで供給され、半導体EMC・アンダーフィル、エポキシ・フェノール・シリコーン・アクリルなど多様な樹脂マトリックスに最適化されます。",
    image: surfaceModImg,
    category: "advanced-series",
    features: [
      ...
      { title: "🔧 2종 그레이드", desc: "결정형(SN-HJG) · 용융형(SN-HRG) 선택", enTitle: "🔧 Dual Grade", jaTitle: "🔧 2種グレード", enDesc: "Crystalline SN-HJG and fused SN-HRG", jaDesc: "結晶質(SN-HJG)・溶融質(SN-HRG)の選択" },
    ...
    isCategoryIndex: true,
    subModels: [
      { code: "SN-HJG", slug: "sl-hjg", spec: "표면개질 결정형 (Active Crystalline)", enSpec: "Surface-Modified Crystalline (Active Crystalline)", jaSpec: "表面改質 結晶質 (活性結晶)", name: "SN-HJG 표면개질 결정형 실리카 분말", enName: "SN-HJG · Surface-Modified Crystalline Silica Powder", jaName: "SN-HJG 表面改質 結晶質シリカ粉末" },
      { code: "SN-HRG", slug: "sl-hrg", spec: "표면개질 용융형 (Active Fused)", enSpec: "Surface-Modified Fused (Active Fused)", jaSpec: "表面改質 溶融質 (活性溶融)", name: "SN-HRG 표면개질 용융형 실리카 분말", enName: "SN-HRG · Surface-Modified Fused Silica Powder", jaName: "SN-HRG 表面改質 溶融質シリカ粉末" },
      { code: "SN-DRG07", slug: "sl-drg07", spec: "표준 등급 (에폭시 실란 표면처리)", enSpec: "Standard Grade (Epoxy-Silane Treated)", jaSpec: "標準グレード (エポキシシラン表面処理)", name: "SN-DRG07 표면개질 실리카 분말", enName: "SN-DRG07 · Surface-Modified Silica Powder", jaName: "SN-DRG07 表面改質シリカ粉末" },
      { code: "SN-DRG07-A", slug: "sl-drg07-a", spec: "고순도 등급 (에폭시 실란 표면처리)", enSpec: "High-Purity Grade (Epoxy-Silane Treated)", jaSpec: "高純度グレード (エポキシシラン表面処理)", name: "SN-DRG07-A 표면개질 실리카 분말", enName: "SN-DRG07-A · Surface-Modified Silica Powder", jaName: "SN-DRG07-A 表面改質シリカ粉末" },
    ],
  ...
  },
  {
    ...
    description:
      "실리카 사 및 입자 시리즈는 고순도 석영을 선별·정제한 결정형 석영사(SN-CS), 초고온 용융을 거친 용융형 석영사(SN-FS), 그리고 반도체·첨단 패키징용 초고순도 미분 용융 실리카(SN-HF04)로 구성됩니다. SN-CS는 SiO₂ 98.0~99.9%의 결정 석영사로 유리 원료·정밀 주조·연마재·워터 필터·스포츠 표면재 등 광범위한 산업에 사용되며, SN-FS는 SiO₂ 99.0~99.99%·저열팽창(0.5×10⁻⁶)·우수한 내화학성을 바탕으로 고온 공정과 정밀 주조에 적합합니다. SN-HF04는 SiO₂ 99.96%·Fe₂O₃ ~12 ppm·D50 3.8µm의 초미분 비정질 용융 실리카로, 반도체 EMC·언더필·어드밴스드 패키징·CCL/PCB·5G 고주파 기판·고열전도 소재 등 최첨단 전자·반도체 분야에 최적화된 프리미엄 필러입니다. 세 라인업 모두 국내·중국 이원화 공급망을 통해 안정적으로 공급됩니다.",
    enDescription:
      "The Silica Powder & Granule series comprises crystalline quartz sand (SN-CS) purified from high-grade quartz, fused quartz sand (SN-FS) processed at ultra-high temperature, and ultra-high-purity micronized fused silica (SN-HF04) for semiconductor and advanced packaging use. SN-CS (SiO₂ 98.0–99.9%) serves a wide range of industries including glass raw material, precision casting, abrasives, water filtration and sports surfaces. SN-FS (SiO₂ 99.0–99.99%) offers low CTE (0.5×10⁻⁶) and excellent chemical resistance for high-temperature processes and precision casting. SN-HF04 is an ultra-fine amorphous fused silica (SiO₂ 99.96%, Fe₂O₃ ~12 ppm, D50 3.8 µm) — a premium filler optimized for semiconductor EMC, underfill, advanced packaging, CCL/PCB, 5G high-frequency substrates and high-thermal-conductivity materials. All three lineups are supplied through a stable dual Korea/China supply chain.",
    jaDescription:
      "シリカパウダー・粒シリーズは高純度石英を選別・精製した結晶質石英砂(SN-CS)、超高温溶融を経た溶融質石英砂(SN-FS)、そして半導体・先端パッケージ用の超高純度微粉溶融シリカ(SN-HF04)で構成されます。SN-CSはSiO₂ 98.0~99.9%の結晶石英砂で、ガラス原料・精密鋳造・研磨材・浄水フィルター・スポーツ表面材など幅広い産業に使用されます。SN-FSはSiO₂ 99.0~99.99%・低熱膨張(0.5×10⁻⁶)・優れた耐化学性を備え、高温工程や精密鋳造に適します。SN-HF04はSiO₂ 99.96%・Fe₂O₃ ~12 ppm・D50 3.8µmの超微粉非晶質溶融シリカで、半導体EMC・アンダーフィル・先端パッケージング・CCL/PCB・5G高周波基板・高熱伝導材料など最先端の電子・半導体分野に最適化されたプレミアムフィラーです。3つのラインアップはすべて韓国・中国二元化サプライチェーンで安定供給されます。",
    image: sandGranuleImg,
    category: "advanced-series",
    features: [
      { title: "🪨 결정·용융 2종 라인업", desc: "결정형 SN-CS · 용융형 SN-FS 선택 가능", enTitle: "🪨 Crystalline & Fused Lineup", jaTitle: "🪨 結晶・溶融 2種ラインアップ", enDesc: "Choice of crystalline SN-CS and fused SN-FS", jaDesc: "結晶質SN-CS・溶融質SN-FSの選択が可能" },
      { title: "🧪 고순도 SiO₂ 98.0 ~ 99.99%", desc: "결정 SN-CS 98.0~99.9% · 용융 SN-FS 99.0~99.99%", enTitle: "🧪 High Purity SiO₂ 98.0–99.99%", jaTitle: "🧪 高純度SiO₂ 98.0~99.99%", enDesc: "Crystalline SN-CS 98.0–99.9% · Fused SN-FS 99.0–99.99%", jaDesc: "結晶SN-CS 98.0~99.9% · 溶融SN-FS 99.0~99.99%" },
      { title: "📐 광범위 입도", desc: "SN-CS: 6-8/8-16/16-26/26-40/40-70/70-120 mesh · SN-FS: 0-60mm, 8-5mm, ..., 120F 등", enTitle: "📐 Wide Grain Size Range", jaTitle: "📐 広範な粒度", enDesc: "SN-CS: 6-8/8-16/16-26/26-40/40-70/70-120 mesh · SN-FS: 0-60mm to 120F", jaDesc: "SN-CS: 6-8~70-120 mesh · SN-FS: 0-60mmから120Fまで" },
      ...
      { title: "🔥 고내열성 (SN-FS)", desc: "저열팽창(0.5×10⁻⁶) · 우수한 내화학성", enTitle: "🔥 High Heat Resistance (SN-FS)", jaTitle: "🔥 高耐熱性 (SN-FS)", enDesc: "Low CTE (0.5×10⁻⁶) with excellent chemical resistance", jaDesc: "低熱膨張(0.5×10⁻⁶) · 優れた耐化学性" },
    ...
    specs: [
      ...
      { label: "SiO₂ 순도", value: "98.0 ~ 99.9 % (SN-CS) / 99.0 ~ 99.99 % (SN-FS)", enValue: "98.0–99.9 % (SN-CS) / 99.0–99.99 % (SN-FS)", jaValue: "98.0~99.9 % (SN-CS) / 99.0~99.99 % (SN-FS)", enLabel: "SiO₂ Purity", jaLabel: "SiO₂純度" },
      { label: "팽창계수 / PH (SN-FS)", value: "0.5×10⁻⁶ / 5 ~ 8", enValue: "0.5×10⁻⁶ / 5–8", jaValue: "0.5×10⁻⁶ / 5~8", enLabel: "Expansion / PH (SN-FS)", jaLabel: "膨張係数 / PH (SN-FS)" },
      { label: "입도 (SN-CS)", value: "6-8, 8-16, 16-26, 26-40, 40-70, 70-120 mesh 등", enValue: "6-8, 8-16, 16-26, 26-40, 40-70, 70-120 mesh, etc.", jaValue: "6-8, 8-16, 16-26, 26-40, 40-70, 70-120 mesh 等", enLabel: "Grain Size (SN-CS)", jaLabel: "粒度 (SN-CS)" },
      { label: "입도 (SN-FS)", value: "0-60mm, 8-5mm, 5-3mm, 3-1mm, 1-0mm, 1-0.5mm, 0.5-0.1mm, 4+10~-60+120 mesh, 120F 등", enValue: "0-60mm, 8-5mm, ..., 4+10~-60+120 mesh, 120F, etc.", jaValue: "0-60mm, 8-5mm, ..., 4+10~-60+120 mesh, 120F 等", enLabel: "Grain Size (SN-FS)", jaLabel: "粒度 (SN-FS)" },
    ...
    isCategoryIndex: true,
    subModels: [
      { code: "SN-CS", slug: "sl-cs", spec: "결정 석영사", enSpec: "Crystalline Quartz Sand", jaSpec: "結晶石英砂", name: "SN-CS 결정 석영사", enName: "SN-CS · Crystalline Quartz Sand", jaName: "SN-CS 結晶石英砂" },
      { code: "SN-FS", slug: "sl-fs", spec: "용융 석영사", enSpec: "Fused Quartz Sand", jaSpec: "溶融石英砂", name: "SN-FS 용융 석영사", enName: "SN-FS · Fused Quartz Sand", jaName: "SN-FS 溶融石英砂" },
      { code: "SN-HF04", slug: "sl-hf04", spec: "고순도 용융 실리카 분말 (SiO₂ 99.96% · D50 3.8µm)", enSpec: "Ultra-High-Purity Fused Silica Powder (SiO₂ 99.96% · D50 3.8 µm)", jaSpec: "高純度溶融シリカ粉末 (SiO₂ 99.96% · D50 3.8µm)", name: "SN-HF04 고순도 용융 실리카 분말", enName: "SN-HF04 · Ultra-High-Purity Fused Silica Powder", jaName: "SN-HF04 高純度溶融シリカ粉末" },
      { code: "SN-SPH-300", slug: "sl-sph-300", spec: "화학합성 나노구상 (D50 0.38µm · SiO₂ 99.98%)", enSpec: "Chemically Synthesized Nano-Spherical (D50 0.38 µm · SiO₂ 99.98%)", jaSpec: "化学合成ナノ球状 (D50 0.38µm · SiO₂ 99.98%)", name: "SN-SPH-300 고순도 나노구상실리카", enName: "SN-SPH-300 · Ultra-High-Purity Nano Spherical Silica", jaName: "SN-SPH-300 高純度ナノ球状シリカ" },
    ],
  ...
  },
  {
    ...
    isCategoryIndex: true,
    subModels: [
      { code: "SN-ZT", slug: "sl-zt", spec: "무연 봉착 유리 프릿", enSpec: "Lead-Free Sealing Glass Frit", jaSpec: "無鉛封着ガラスフリット", name: "SN-ZT 무연 봉착 유리 프릿", enName: "SN-ZT · Lead-Free Sealing Glass Frit", jaName: "SN-ZT 無鉛封着ガラスフリット" },
    ],
...
// Non-활성 sub-models inherit features/specs/applications from parent; 활성 (SN-DRG07/-A) get PDF-specific data.
const surfaceModelOverrides: Record<string, Partial<ProductDetail>> = {
  "sl-drg07": {
    ...
    description: "SN-DRG07은 정밀한 입도 분포와 엄격한 화학적 순도 관리를 통해 반도체, 세라믹 및 첨단 소재 산업의 공정 효율성을 극대화하는 고순도 표면개질(에폭시 실란) 실리카입니다. SiO₂ ≥99.7%(대표치 99.75%)와 D50 6.6μm 수준의 균일한 입도 분포로 EMC·언더필·고신뢰성 접착제 배합에 최적화되어 있습니다.",
    enDescription: "SN-DRG07 is a high-purity epoxy-silane surface-modified silica engineered for semiconductor, ceramic and advanced material industries, delivering process efficiency through precise particle size distribution and rigorous chemical purity. With SiO₂ ≥99.7% (typical 99.75%) and uniform D50 around 6.6 µm, it is optimized for EMC, underfill and high-reliability adhesive formulations.",
    jaDescription: "SN-DRG07は精密な粒度分布と厳格な化学的純度管理により、半導体・セラミックス・先端素材産業の工程効率を最大化する高純度表面改質(エポキシシラン)シリカです。SiO₂ ≥99.7%(代表値99.75%)、D50 約6.6μmの均一な粒度分布で、EMC・アンダーフィル・高信頼性接着剤配合に最適化されています。",
    specs: [
      { label: "품번 (Code)", value: "SN-DRG07", enLabel: "Code", jaLabel: "品番 (Code)" },
      { label: "외관", value: "백색 표면개질 분말", enValue: "White surface-modified powder", jaValue: "白色表面改質粉末", enLabel: "Appearance", jaLabel: "外観" },
  ...
  "sl-drg07-a": {
    ...
    description: "SN-DRG07-A는 SN-DRG07 대비 더욱 엄격한 순도 관리를 적용한 고순도 등급 표면개질(에폭시 실란) 실리카입니다. SiO₂ 대표치 99.80%, Fe₂O₃ 30 ppm급의 초저철분과 D50 6.4μm 수준의 미세 균일 입도로 HBM·AI 반도체용 EMC 및 고신뢰성 언더필에 대응합니다. 입도 분포는 고객 요구에 따라 조정 가능합니다.",
    enDescription: "SN-DRG07-A applies even stricter purity control than SN-DRG07 — a high-purity epoxy-silane surface-modified silica with SiO₂ typical 99.80%, Fe₂O₃ 30 ppm-class ultra-low iron and fine, uniform D50 of about 6.4 µm. Designed for HBM/AI semiconductor EMC and high-reliability underfill. Particle size distribution can be adjusted per customer requirement.",
    jaDescription: "SN-DRG07-AはSN-DRG07よりさらに厳格な純度管理を適用した高純度グレードの表面改質(エポキシシラン)シリカです。SiO₂代表値99.80%、Fe₂O₃ 30ppm級の超低鉄分、D50約6.4μmの微細均一粒度でHBM・AI半導体用EMCおよび高信頼性アンダーフィルに対応します。粒度分布はお客様のご要求に応じて調整可能です。",
    specs: [
      { label: "품번 (Code)", value: "SN-DRG07-A", enLabel: "Code", jaLabel: "品番 (Code)" },
      { label: "외관", value: "백색 표면개질 분말", enValue: "White surface-modified powder", jaValue: "白色表面改質粉末", enLabel: "Appearance", jaLabel: "外観" },
      { label: "표면 처리제", value: "에폭시 실란 (Epoxy silane)", enValue: "Epoxy silane", jaValue: "エポキシシラン (Epoxy silane)", enLabel: "Surface Treatment", jaLabel: "表面処理剤" },
  ...
  "sl-qg": {
    ...
    description: "SN-QG 시리즈 구상 실리카 분말은 고순도 이산화규소를 원료로 화염 용융법·금속 실리콘 폭연법·화학 합성법을 통해 가공된 구상 SiO₂ 분말 소재입니다. 저비표면적, 우수한 유동성, 저응력이 특징입니다.",
    enDescription: "SN-QG series Spherical Silica Powder is a spherical SiO₂ powder produced from high-purity silica by flame fusion, metallic silicon deflagration or chemical synthesis. Featured by small specific surface area, good liquidity and low stress.",
    jaDescription: "SN-QGシリーズ球状シリカ粉末は、高純度シリカを原料に火炎溶融法・金属Si爆燃法・化学合成法で加工した球状SiO₂粉末素材です。小比表面積・優れた流動性・低応力が特徴です。",
    specs: [
      { label: "품번 (Code)", value: "SN-QG", enLabel: "Code", jaLabel: "品番 (Code)" },
  ...
  "sl-qg-l": {
    ...
    description: "SN-QG-L 시리즈 저방사선 구상 실리카 분말은 고순도·저방사성 이산화규소를 원료로 화염 용융법으로 가공된 구상 SiO₂ 소재입니다. 방사성 원소 함량이 낮아 첨단 메모리 반도체 EMC용으로 사용됩니다.",
    enDescription: "SN-QG-L series Low-α Spherical Silica Powder is made from high-purity, low-radiation silica by flame-fusion into spherical SiO₂ powder. Its low radioactive element content makes it suitable for advanced memory semiconductor EMC.",
    jaDescription: "SN-QG-Lシリーズ低α線球状シリカ粉末は、高純度・低放射性シリカを原料に火炎溶融法で加工した球状SiO₂素材です。放射性元素含有量が低く、先端メモリ半導体EMC用途に使用されます。",
    specs: [
      { label: "품번 (Code)", value: "SN-QG-L", enLabel: "Code", jaLabel: "品番 (Code)" },
      { label: "SiO₂", value: "99.0 ~ 99.95 %", enLabel: "SiO₂", jaLabel: "SiO₂" },
      { label: "외관", value: "백색 분말", enValue: "White powder", jaValue: "白色粉末", enLabel: "Appearance", jaLabel: "外観" },
      { label: "형상", value: "구상(Spherical)", enValue: "Spherical", jaValue: "球形(Spherical)", enLabel: "Morphology", jaLabel: "形状" },
      { label: "PH", value: "5 ~ 8", enLabel: "PH", jaLabel: "PH" },
  ...
  "sl-yjg": {
    ...
    description: "SN-YJG 시리즈 결정형 모서리 라운드 실리카 분말은 고순도 결정형 이산화규소 분말을 원료로 정형 설비로 가공하여 입자 표면을 더욱 매끄럽고 유동성을 향상시킨 소재입니다.",
    enDescription: "SN-YJG series Round-Corner Crystalline Silica Powder is made from high-purity crystalline silica powder and processed by shaping equipment to make particle surfaces rounder and flowability better.",
    jaDescription: "SN-YJGシリーズ結晶質丸角シリカ粉末は、高純度結晶質シリカ粉末を原料に整形設備で加工し、粒子表面をより丸め流動性を向上させた素材です。",
    specs: [
      { label: "품번 (Code)", value: "SN-YJG", enLabel: "Code", jaLabel: "品番 (Code)" },
      { label: "SiO₂", value: "98.0 ~ 99.9 %", enLabel: "SiO₂", jaLabel: "SiO₂" },
      { label: "외관", value: "백색 분말", enValue: "White powder", jaValue: "白色粉末", enLabel: "Appearance", jaLabel: "外観" },
      { label: "백도", value: "90 이상", enValue: "90 Min", jaValue: "90以上", enLabel: "Whiteness", jaLabel: "白度" },
      { label: "모스경도", value: "7", enLabel: "Mohs Hardness", jaLabel: "モース硬度" },
  ...
  "sl-yrg": {
    ...
    description: "SN-YRG 시리즈 용융형 모서리 라운드 실리카 분말은 고순도 용융 이산화규소 분말을 원료로 정형 설비로 가공하여 입자 표면을 더 매끄럽고 유동성을 개선한 소재입니다.",
    enDescription: "SN-YRG series Round-Corner Fused Silica Powder is made from high-purity fused silica powder and processed by shaping equipment to make particle surfaces rounder and flowability better.",
    jaDescription: "SN-YRGシリーズ溶融質丸角シリカ粉末は、高純度溶融シリカ粉末を原料に整形設備で加工し、粒子表面をより丸め流動性を改善した素材です。",
    specs: [
      { label: "품번 (Code)", value: "SN-YRG", enLabel: "Code", jaLabel: "品番 (Code)" },
      { label: "SiO₂", value: "99.0 ~ 99.95 %", enLabel: "SiO₂", jaLabel: "SiO₂" },
      { label: "외관", value: "백색 분말", enValue: "White powder", jaValue: "白色粉末", enLabel: "Appearance", jaLabel: "外観" },
  ...
  "sl-rg": {
    ...
    description: "SN-RG 시리즈 용융 실리카 분말은 고순도 석영을 원료로 전기 용융을 통해 생산된 무정형 이산화규소를 분선·볼밀·분급 공정으로 가공한 무정형 SiO₂ 분체 소재입니다.",
    enDescription: "SN-RG series Fused Silica Powder is made from high-purity crystal silica by electrically fusing to amorphous silica, then processed by sorting, ball milling and air classifying into amorphous SiO₂ powder.",
    jaDescription: "SN-RGシリーズ溶融シリカ粉末は、高純度石英を原料に電気溶融で無定形二酸化ケイ素を生成し、分選・ボールミル・分級工程で加工した無定形SiO₂粉体素材です。",
    specs: [
      { label: "품번 (Code)", value: "SN-RG", enLabel: "Code", jaLabel: "品番 (Code)" },
      { label: "SiO₂", value: "99.0 ~ 99.95 %", enLabel: "SiO₂", jaLabel: "SiO₂" },
      { label: "외관", value: "백색 분말", enValue: "White powder", jaValue: "白色粉末", enLabel: "Appearance", jaLabel: "外観" },
      { label: "팽창계수", value: "0.5×10⁻⁶", enLabel: "Expansion Coefficient", jaLabel: "膨張係数" },
      { label: "PH", value: "5 ~ 8", enLabel: "PH", jaLabel: "PH" },
  ...
  "sl-jg": {
    ...
    description: "SN-JG 시리즈 결정 실리카 분말은 고순도 석영을 원료로 전문 정제 공정과 가공 설비를 통해 생산된 SiO₂ 분체 소재로, 균일하고 안정적인 초미세 입도가 특징입니다.",
    enDescription: "SN-JG series Crystalline Silica Powder is made from high-purity silica through professional purification and processing equipment, characterized by uniform, stable and ultra-fine particle size.",
    jaDescription: "SN-JGシリーズ結晶質シリカ粉末は、高純度石英を原料に専門的な精製工程と加工設備で生産したSiO₂粉体素材で、均一で安定した超微細粒度が特徴です。",
    specs: [
      { label: "품번 (Code)", value: "SN-JG", enLabel: "Code", jaLabel: "品番 (Code)" },
      { label: "SiO₂", value: "98.0 ~ 99.9 %", enLabel: "SiO₂", jaLabel: "SiO₂" },
      { label: "외관", value: "백색 분말", enValue: "White powder", jaValue: "白色粉末", enLabel: "Appearance", jaLabel: "外観" },
      { label: "백도", value: "90 이상", enValue: "90 Min", jaValue: "90以上", enLabel: "Whiteness", jaLabel: "白度" },
      { label: "모스경도", value: "7", enLabel: "Mohs Hardness", jaLabel: "モース硬度" },
  ...
  "sl-cl": {
    ...
    description: "SN-CL 시리즈 저방사선 결정 실리카 분말은 저방사성 결정 이산화규소를 원료로 자체 설계된 전문 설비로 가공된 SiO₂ 분체 소재입니다.",
    enDescription: "SN-CL series Low-α Crystalline Silica Powder is made from low-radiation crystalline silica processed to powder by proprietary professional equipment.",
    jaDescription: "SN-CLシリーズ低α線結晶質シリカ粉末は、低放射性結晶質シリカを原料に、自社設計の専門設備で加工したSiO₂粉体素材です。",
    specs: [
      { label: "품번 (Code)", value: "SN-CL", enLabel: "Code", jaLabel: "品番 (Code)" },
      { label: "SiO₂", value: "98.0 ~ 99.9 %", enLabel: "SiO₂", jaLabel: "SiO₂" },
      { label: "외관", value: "백색 분말", enValue: "White powder", jaValue: "白色粉末", enLabel: "Appearance", jaLabel: "外観" },
      { label: "백도", value: "90 이상", enValue: "90 Min", jaValue: "90以上", enLabel: "Whiteness", jaLabel: "白度" },
      { label: "모스경도", value: "7", enLabel: "Mohs Hardness", jaLabel: "モース硬度" },
  ...
  "sl-fl": {
    ...
    description: "SN-FL 시리즈 저방사선 용융 실리카 분말은 저방사성 결정 이산화규소를 원료로 고온 용융 및 전문 설비 가공을 거쳐 제조된 SiO₂ 분체 소재입니다.",
    enDescription: "SN-FL series Low-α Fused Silica Powder is made from low-radiation crystalline silica processed to powder by high-temperature smelting and professional equipment.",
    jaDescription: "SN-FLシリーズ低α線溶融シリカ粉末は、低放射性結晶質シリカを原料に高温溶融および専門設備で加工したSiO₂粉体素材です。",
    specs: [
      { label: "품번 (Code)", value: "SN-FL", enLabel: "Code", jaLabel: "品番 (Code)" },
      { label: "SiO₂", value: "99.0 ~ 99.95 %", enLabel: "SiO₂", jaLabel: "SiO₂" },
      { label: "외관", value: "백색 분말", enValue: "White powder", jaValue: "白色粉末", enLabel: "Appearance", jaLabel: "外観" },
      { label: "백도", value: "90 이상", enValue: "90 Min", jaValue: "90以上", enLabel: "Whiteness", jaLabel: "白度" },
      { label: "PH", value: "5 ~ 8", enLabel: "PH", jaLabel: "PH" },
  ...
  "sl-cs": {
    ...
    description: "SN-CS 시리즈 결정 석영사는 고순도 석영을 원료로 수세·정제·파쇄·철분 제거·선별 등 다단계 공정을 거쳐 다양한 덩어리·입자·분말 형태로 가공됩니다.",
    enDescription: "SN-CS series Crystalline Quartz Sand is made from high-purity natural quartz through washing, purifying, crushing, iron removal and screening, producing lump, grain and powder products.",
    jaDescription: "SN-CSシリーズ結晶石英砂は、高純度石英を原料に水洗・精製・破砕・鉄分除去・選別など多段階工程を経て、様々な塊・粒子・粉末形態で加工されます。",
    specs: [
      { label: "품번 (Code)", value: "SN-CS", enLabel: "Code", jaLabel: "品番 (Code)" },
      { label: "SiO₂", value: "98.0 ~ 99.9 %", enLabel: "SiO₂", jaLabel: "SiO₂" },
  ...
  "sl-fs": {
    ...
    description: "SN-FS 시리즈 용융 석영사는 고순도 석영을 원료로 전기 용융을 통해 생산된 무정형 이산화규소를 전용 기계로 가공하여 덩어리·입자·분말 제품으로 공급됩니다.",
    enDescription: "SN-FS series Fused Silica Sand is made from high-purity crystal silica by electrically fusing to amorphous silica, then machined into lump, grain and powder products.",
    jaDescription: "SN-FSシリーズ溶融石英砂は、高純度石英を原料に電気溶融で生成した無定形二酸化ケイ素を、専用機械で塊・粒子・粉末製品に加工して供給します。",
    specs: [
      { label: "품번 (Code)", value: "SN-FS", enLabel: "Code", jaLabel: "品番 (Code)" },
  ...
  "sl-hf04": {
    tagline: "SiO₂ 99.96% · D50 3.8µm — 반도체·전자소재용 초고순도 미분 용융 실리카 (SN-HF04)",
    enTagline: "SiO₂ 99.96% · D50 3.8 µm — Ultra-High-Purity Micronized Fused Silica for Semiconductor & Electronic Materials (SN-HF04)",
    jaTagline: "SiO₂ 99.96% · D50 3.8µm — 半導体・電子素材用 超高純度微粉溶融シリカ (SN-HF04)",
    description:
      "SN-HF04는 천연 고순도 석영을 초고온(약 2,000℃)에서 전용융(Fused)한 뒤 정밀 미분쇄 및 다단 분급을 통해 제조된 초고순도 무정형(Amorphous) 용융 실리카 분말입니다. SiO₂ 순도 대표치 99.96%(규격 ≥99.95%), Fe₂O₃ 12ppm 수준의 극저철분, 100ppm 이하의 Al₂O₃, 그리고 D10 1.6µm / D50 3.8µm / D90 6.6µm의 좁고 균일한 미분 입도 분포를 특징으로 합니다. 열팽창계수가 매우 낮고(약 0.5×10⁻⁶/℃), 유전율·유전손실이 낮으며, 화학적으로 극히 안정하여 반도체 EMC(Epoxy Molding Compound), 언더필, 봉지재, 어드밴스드 패키징(FO-WLP·FC-BGA), CCL·PCB 프리프레그, 5G/고주파 기판, 방열 실리콘, LED/OLED 봉지, 정밀 세라믹·석영 유리 원료 등 최고 수준의 신뢰성과 순도가 요구되는 첨단 전자·광학·에너지 소재에 최적화된 프리미엄 필러입니다.",
    enDescription:
      "SN-HF04 is an ultra-high-purity amorphous fused silica powder produced by melting selected high-grade quartz at approximately 2,000℃ and then precision-milling and classifying it into a narrow micronized particle size distribution. It offers a typical SiO₂ purity of 99.96% (spec ≥99.95%), extremely low iron content (Fe₂O₃ ~12 ppm), Al₂O₃ below 100 ppm, and a tightly controlled PSD of D10 1.6 µm / D50 3.8 µm / D90 6.6 µm. With a very low CTE (~0.5×10⁻⁶/℃), low dielectric constant and loss, and outstanding chemical stability, SN-HF04 is an optimized premium filler for the most demanding advanced electronic, optical and energy materials — including semiconductor EMC, underfill, encapsulants, advanced packaging (FO-WLP, FC-BGA), CCL / PCB prepreg, 5G / high-frequency substrates, thermally conductive silicones, LED / OLED encapsulation, and precision ceramics and quartz-glass raw material.",
    jaDescription:
      "SN-HF04は選別された高純度石英を約2,000℃で全溶融(Fused)し、精密微粉砕・多段分級を経て製造される超高純度非晶質(Amorphous)溶融シリカ粉末です。SiO₂純度は代表値99.96%(規格≥99.95%)、Fe₂O₃約12ppmの極低鉄分、Al₂O₃100ppm以下、そしてD10 1.6µm / D50 3.8µm / D90 6.6µmの狭く均一な微粉粒度分布を特徴とします。極めて低い熱膨張係数(約0.5×10⁻⁶/℃)、低誘電率・低誘電損失、優れた化学的安定性により、半導体EMC・アンダーフィル・封止材・先端パッケージ(FO-WLP・FC-BGA)・CCL/PCBプリプレグ・5G/高周波基板・放熱シリコーン・LED/OLED封止・精密セラミックス・石英ガラス原料など、最高水準の信頼性と純度が要求される先端電子・光学・エネルギー素材に最適化されたプレミアムフィラーです。",
    image: hf04Img,
    features: [
    ...
    specs: [
      { label: "제품 코드", value: "SN-HF04", enLabel: "Product Code", jaLabel: "製品コード" },
  ...
  "sl-sph-300": {
    ...
    specs: [
      { label: "제품 코드", value: "SN-SPH-300", enLabel: "Product Code", jaLabel: "製品コード" },
  ...
  "sl-spj-300": {
    ...
    specs: [
      { label: "제품 코드", value: "SN-SPJ-300", enLabel: "Product Code", jaLabel: "製品コード" },
  ...
  "sl-fpo10": {
    ...
    features: [
      ...
      { title: "⚪ 구상 용융 실리카", desc: "비정질 용융 실리카를 구상화 — 저점도·고충전·저응력 배합", enTitle: "⚪ Spherical Fused Silica", jaTitle: "⚪ 球状溶融シリカ", enDesc: "Spheroidized amorphous fused silica — low viscosity, high loading, low stress", jaDesc: "非晶質溶融シリカを球状化 — 低粘度・高充填・低応力配合" },
      ...
      { title: "🚫 조대 입자 배제", desc: "15 µm 이상 누적 100% — 노즐 막힘·스크래치 결함 억제", enTitle: "🚫 No Oversize Particles", jaTitle: "🚫 粗大粒子の排除", enDesc: "100% cumulative below 15 µm — suppresses nozzle clogging and scratch defects", jaDesc: "15 µm以上は累積100% — ノズル詰まり・スクラッチ欠陥を抑制" },
    ...
    specs: [
      { label: "제품 코드", value: "SN-FPO10", enLabel: "Product Code", jaLabel: "製品コード" },
      { label: "외관", value: "백색 구상 분말", enValue: "White spherical powder", jaValue: "白色球状粉末", enLabel: "Appearance", jaLabel: "外観" },
      { label: "형상 / 구조", value: "구상 (Spherical) · 비정질 용융", enValue: "Spherical · amorphous fused", jaValue: "球状 · 非晶質溶融", enLabel: "Morphology / Structure", jaLabel: "形状 / 構造" },
  ...
  "sl-fp10": {
    ...
    specs: [
      { label: "제품 코드", value: "SN-FP10", enLabel: "Product Code", jaLabel: "製品コード" },
      { label: "외관", value: "백색 각상 분말", enValue: "White angular powder", jaValue: "白色角形粉末", enLabel: "Appearance", jaLabel: "外観" },
...
// SN-series fused variants). Each member also keeps its original category.
...
productCatalog.push({
  ...
  enTagline: "A · B · C grades and every SN-series fused silica in one place — for semiconductor, optics, EMC, precision casting and advanced packaging",
  ...
  enDescription:
    "Fused Silica is an amorphous SiO₂ material made by melting natural quartz at over 1,800°C and rapidly quenching it. It delivers ultra-low CTE (0.5–0.6 ×10⁻⁶/°C), excellent thermal-shock resistance, chemical stability and electrical insulation — a core raw material for advanced industries. SiLiCA supplies Grade A (SiO₂ ≥99.9%, 100% amorphous), Grade B (≥99.5%) and Grade C (≥99%) as flagship purity tiers, together with the full SN-series fused-silica lineup by shape/function: spherical (SN-QG), low-α spherical (SN-QG-L), round-corner (SN-YRG), angular (SN-RG), low-radiation (SN-FL), surface-modified (SN-HRG), fused quartz sand (SN-FS) and ultra-high-purity fine powder (SN-HF04). We supply these as custom-processed products centered on the fused-silica lineup.",
  jaDescription:
  ...
  features: [
    ...
    { title: "🔷 전 SL 시리즈 형상 라인업", desc: "구상(SN-QG)·모서리 라운드(SN-YRG)·각상(SN-RG)·미분(SN-HF04)·석영사(SN-FS) 등 형상·입도·기능별 커버", enTitle: "🔷 Full SN-Series Shape Lineup", jaTitle: "🔷 全SLシリーズ形状ラインアップ", enDesc: "Spherical (SN-QG), round-corner (SN-YRG), angular (SN-RG), fine powder (SN-HF04), quartz sand (SN-FS) and more", jaDesc: "球状(SN-QG)・丸角(SN-YRG)・角形(SN-RG)・微粉(SN-HF04)・石英砂(SN-FS)など形状・粒度・機能別に対応" },
    { title: "☢️ 저방사선(Low-α) 대응", desc: "SN-QG-L / SN-FL — HBM·DDR5·AI 반도체 소프트에러 방지용 α선 ≤ 0.001 cph/cm²", enTitle: "☢️ Low-α Options", jaTitle: "☢️ 低α線対応", enDesc: "SN-QG-L / SN-FL — α ≤ 0.001 cph/cm² for HBM, DDR5, AI-semiconductor soft-error suppression", jaDesc: "SN-QG-L / SN-FL — HBM・DDR5・AI半導体のソフトエラー抑制用 α線 ≤ 0.001 cph/cm²" },
    { title: "⚗️ 표면개질(활성) 그레이드", desc: "SN-HRG — 실란 커플링 처리로 유기 매트릭스와의 접착·분산성 극대화", enTitle: "⚗️ Surface-Modified Grade", jaTitle: "⚗️ 表面改質(活性)グレード", enDesc: "SN-HRG — silane-coupled treatment maximizes adhesion and dispersion in organic matrices", jaDesc: "SN-HRG — シランカップリング処理で有機マトリクスとの接着・分散性を最大化" },
  ...
  specs: [
    { label: "제품 라인업", value: "A / B / C 등급 + SN-QG · SN-QG-L · SN-YRG · SN-RG · SN-FL · SN-HRG · SN-FS · SN-HF04", enValue: "A/B/C grades + SN-QG · SN-QG-L · SN-YRG · SN-RG · SN-FL · SN-HRG · SN-FS · SN-HF04", jaValue: "A/B/Cグレード + SN-QG · SN-QG-L · SN-YRG · SN-RG · SN-FL · SN-HRG · SN-FS · SN-HF04", enLabel: "Product Lineup", jaLabel: "製品ラインアップ" },
    ...
    { label: "저방사선(Low-α)", value: "SN-QG-L / SN-FL 그레이드 — α ≤ 0.001 cph/cm²", enValue: "SN-QG-L / SN-FL grades — α ≤ 0.001 cph/cm²", jaValue: "SN-QG-L / SN-FLグレード — α ≤ 0.001 cph/cm²", enLabel: "Low-α Option", jaLabel: "低α線オプション" },
    { label: "표면개질", value: "SN-HRG (실란 커플링) 그레이드 별도 공급", enValue: "SN-HRG (silane-coupled) grade available", jaValue: "SN-HRG (シランカップリング)グレード供給可", enLabel: "Surface Modification", jaLabel: "表面改質" },
  ...
  subModels: [
    ...
    { code: "SN-QG", slug: "sl-qg", spec: "구상 (화염 용융)", enSpec: "Spherical (flame-fusion)", jaSpec: "球状 (火炎溶融)" },
    { code: "SN-QG-L", slug: "sl-qg-l", spec: "저방사선(Low-α) 구상", enSpec: "Low-α Spherical", jaSpec: "低α線 球状" },
    { code: "SN-YRG", slug: "sl-yrg", spec: "용융형 모서리 라운드", enSpec: "Fused Round-Corner", jaSpec: "溶融質 丸角" },
    { code: "SN-RG", slug: "sl-rg", spec: "용융형 각상", enSpec: "Fused Angular", jaSpec: "溶融質 角形" },
    { code: "SN-FL", slug: "sl-fl", spec: "저방사선 용융", enSpec: "Low-Alpha Fused", jaSpec: "低α線 溶融質" },
    { code: "SN-HRG", slug: "sl-hrg", spec: "표면개질 용융", enSpec: "Surface-Modified Fused", jaSpec: "活性(表面改質) 溶融" },
    { code: "SN-FS", slug: "sl-fs", spec: "용융 석영사", enSpec: "Fused Quartz Sand", jaSpec: "溶融石英砂" },
    { code: "SN-HF04", slug: "sl-hf04", spec: "초고순도 미분 용융 (SiO₂ 99.96% · D50 3.8µm)", enSpec: "Ultra-High-Purity Fine Fused (SiO₂ 99.96% · D50 3.8µm)", jaSpec: "超高純度微粉溶融 (SiO₂ 99.96% · D50 3.8µm)" },
    { code: "SN-SPJ-300", slug: "sl-spj-300", spec: "서브미크론 구상 용융 (D50 0.3±0.1µm · 구상화율 98%)", enSpec: "Submicron Spherical Fused (D50 0.3±0.1 µm · 98% spheroidization)", jaSpec: "サブミクロン球状溶融 (D50 0.3±0.1µm · 球状化率98%)" },
    { code: "SN-FPO10", slug: "sl-fpo10", spec: "구상 용융 (D50 9.96µm · SiO₂ 99.93%)", enSpec: "Spherical Fused (D50 9.96 µm · SiO₂ 99.93%)", jaSpec: "球状溶融 (D50 9.96µm · SiO₂ 99.93%)" },
    { code: "SN-FP10", slug: "sl-fp10", spec: "각상 용융 (D50 9.96µm · SiO₂ 99.93%)", enSpec: "Angular Fused (D50 9.96 µm · SiO₂ 99.93%)", jaSpec: "角形溶融 (D50 9.96µm · SiO₂ 99.93%)" },
  ],
  applications: [
...
productCatalog.push({
  ...
  description:
    "쿼츠(Quartz) · 결정질 실리카(Crystalline Silica, α-Quartz)는 천연 수정 광석을 기반으로 정제·분급·결정 형상 제어를 거쳐 제조되는 고순도 α상 SiO₂ 소재로, 용융(Amorphous) 실리카 대비 높은 경도(Mohs 7)·우수한 화학적 안정성·낮은 단가·풍부한 원료 공급성을 갖춘 산업용 대표 실리카입니다. SiLiCA는 결정질 실리카 라인업을 하나의 카테고리로 통합하여, 모서리 라운드 결정형(SN-YJG)·각상 결정형(SN-JG)·저방사선 결정형(SN-CL)·표면개질 결정형(SN-HJG)·결정 석영사(SN-CS) 등 형상·기능·순도별 전 라인업을 CCL/PCB, 반도체 EMC, 정밀 주조, 세라믹, 산업용 코팅, 고내마모 복합재 등 다양한 산업 요구에 맞춰 커스텀 가공 공급합니다.\n\n각 제품은 원래 소속 카테고리(구상·모서리 라운드·각상·저방사선·표면개질·실리카 분말·입자)에도 그대로 유지되므로, 형상·기능별로도 자유롭게 탐색 가능합니다.",
  enDescription:
    "Quartz · Crystalline Silica (α-Quartz) is a high-purity α-phase SiO₂ material refined from natural quartz ore through classification and crystal-shape control. Compared with amorphous fused silica, it offers superior hardness (Mohs 7), excellent chemical stability, cost-competitive pricing and abundant raw-material availability, making it the industrial workhorse silica. SiLiCA consolidates its crystalline lineup — round-corner crystalline (SN-YJG), angular crystalline (SN-JG), low-α crystalline (SN-CL), surface-modified crystalline (SN-HJG) and crystalline quartz sand (SN-CS) — under one category, custom-processed for CCL/PCB, semiconductor EMC, precision casting, ceramics, industrial coatings and high-wear composites.\n\nEach product also remains listed under its original shape/function category (spherical, round-corner, angular, low-α, surface-modified, silica powder & granule), so you can navigate by form factor as well.",
  jaDescription:
    "クォーツ(Quartz)・結晶質シリカ(Crystalline Silica, α-Quartz)は、天然石英原石を精製・分級・結晶形状制御して製造される高純度α相SiO₂素材で、溶融(非晶質)シリカに比べ高硬度(モース7)・優れた化学安定性・低コスト・豊富な原料供給性を兼ね備えた産業用の代表的シリカです。SiLiCAは結晶質ラインアップを一つのカテゴリに統合し、丸角結晶質(SN-YJG)・角形結晶質(SN-JG)・低α線結晶質(SN-CL)・表面改質結晶質(SN-HJG)・結晶石英砂(SN-CS)を、CCL/PCB・半導体EMC・精密鋳造・セラミックス・産業用コーティング・高耐摩耗複合材など多様な用途向けにカスタム加工で供給します。\n\n各製品は元の所属カテゴリ(球状・丸角・角形・低α線・表面改質・シリカ粉末/粒)にもそのまま掲載されるため、形状・機能別にも自由に閲覧できます。",
  ...
  features: [
    ...
    { title: "🔷 전 형상 라인업 통합", desc: "모서리 라운드(SN-YJG)·각상(SN-JG)·저방사선(SN-CL)·표면개질(SN-HJG)·석영사(SN-CS)", enTitle: "🔷 Full Shape Lineup", jaTitle: "🔷 全形状ラインアップ", enDesc: "Round-corner (SN-YJG), angular (SN-JG), low-α (SN-CL), surface-modified (SN-HJG), quartz sand (SN-CS)", jaDesc: "丸角(SN-YJG)・角形(SN-JG)・低α線(SN-CL)・表面改質(SN-HJG)・石英砂(SN-CS)" },
    { title: "☢️ 저방사선(Low-α) 대응", desc: "SN-CL — HBM·DDR5·AI 반도체 소프트에러 방지용 α선 ≤ 0.001 cph/cm²", enTitle: "☢️ Low-α Grade Available", jaTitle: "☢️ 低α線対応", enDesc: "SN-CL — α ≤ 0.001 cph/cm² for HBM, DDR5, AI-semiconductor soft-error suppression", jaDesc: "SN-CL — HBM・DDR5・AI半導体のソフトエラー抑制用 α線 ≤ 0.001 cph/cm²" },
    { title: "⚗️ 표면개질(활성) 결정형", desc: "SN-HJG — 실란 커플링 처리로 유기 매트릭스와의 접착·분산성 극대화", enTitle: "⚗️ Surface-Modified Crystalline", jaTitle: "⚗️ 表面改質(活性)結晶質", enDesc: "SN-HJG — silane-coupled to maximize adhesion and dispersion in organic matrices", jaDesc: "SN-HJG — シランカップリング処理で有機マトリクスとの接着・分散性を最大化" },
  ...
  specs: [
    { label: "제품 라인업", value: "SN-YJG · SN-JG · SN-CL · SN-HJG · SN-CS", enValue: "SN-YJG · SN-JG · SN-CL · SN-HJG · SN-CS", jaValue: "SN-YJG · SN-JG · SN-CL · SN-HJG · SN-CS", enLabel: "Product Lineup", jaLabel: "製品ラインアップ" },
    ...
    { label: "저방사선(Low-α)", value: "SN-CL 그레이드 — α ≤ 0.001 cph/cm²", enValue: "SN-CL grade — α ≤ 0.001 cph/cm²", jaValue: "SN-CLグレード — α ≤ 0.001 cph/cm²", enLabel: "Low-α Option", jaLabel: "低α線オプション" },
    { label: "표면개질", value: "SN-HJG (실란 커플링) 그레이드 별도 공급", enValue: "SN-HJG (silane-coupled) grade available", jaValue: "SN-HJG (シランカップリング)グレード供給可", enLabel: "Surface Modification", jaLabel: "表面改質" },
    { label: "포장", value: "10 / 20 kg 지대 · 500 kg 벌크백 · OEM", enValue: "10 / 20 kg bag · 500 kg bulk · OEM", jaValue: "10 / 20 kg 紙袋 · 500 kg バルク · OEM", enLabel: "Packaging", jaLabel: "包装" },
  ],
  subModelsColumnLabel: { ko: "형상 / 기능", en: "Shape / Function", ja: "形状/機能" },
  subModels: [
    { code: "SN-YJG", slug: "sl-yjg", spec: "결정형 모서리 라운드 (CCL·도전성 페이스트·산업 코팅)", enSpec: "Crystalline Round-Corner (CCL, conductive paste, industrial coatings)", jaSpec: "結晶質 丸角 (CCL・導電性ペースト・産業用コーティング)" },
    { code: "SN-JG", slug: "sl-jg", spec: "결정형 각상 (표준 필러·고내마모 복합재)", enSpec: "Crystalline Angular (standard filler, high-wear composites)", jaSpec: "結晶質 角形 (標準フィラー・高耐摩耗複合材)" },
    { code: "SN-CL", slug: "sl-cl", spec: "저방사선(Low-α) 결정형 — α ≤ 0.001 cph/cm²", enSpec: "Low-α Crystalline — α ≤ 0.001 cph/cm²", jaSpec: "低α線 結晶質 — α ≤ 0.001 cph/cm²" },
    { code: "SN-HJG", slug: "sl-hjg", spec: "표면개질(활성) 결정형 — 실란 커플링 처리", enSpec: "Surface-Modified Crystalline — silane-coupled", jaSpec: "表面改質(活性) 結晶質 — シランカップリング処理" },
    { code: "SN-CS", slug: "sl-cs", spec: "결정 석영사 (유리 원료·정밀 주조·연마재)", enSpec: "Crystalline Quartz Sand (glass raw material, precision casting, abrasives)", jaSpec: "結晶石英砂 (ガラス原料・精密鋳造・研磨材)" },
    { code: "SN-HS12", slug: "sl-hs12", spec: "고순도 결정질 실리카 미분 (SiO₂ ≥99.85% · D50 12±2µm)", enSpec: "High-Purity Crystalline Silica Micro-Powder (SiO₂ ≥99.85% · D50 12±2 µm)", jaSpec: "高純度結晶質シリカ微粉 (SiO₂ ≥99.85% · D50 12±2µm)" },
  ],
  applications: [
...
// ============= SN-HS12 · High-Purity Crystalline Silica Micro-Powder =============
productCatalog.push({
  slug: "sl-hs12",
  name: "SN-HS12 고순도 결정질 실리카 미분",
  enName: "SN-HS12 · High-Purity Crystalline Silica Micro-Powder",
  jaName: "SN-HS12 高純度結晶質シリカ微粉",
  ...
  specs: [
    { label: "제품 코드", value: "SN-HS12", enLabel: "Product Code", jaLabel: "製品コード" },
...
productCatalog.push({
  ...
  features: [
    ...
    { title: "🎛️ 2종 표준 그레이드 · 맞춤 대응", desc: "SN-JA25 / SN-JA30 표준 + 농도·입자경·안정제 커스텀", enTitle: "🎛️ Two Standard Grades · Custom Supply", jaTitle: "🎛️ 2種標準グレード · カスタム対応", enDesc: "SN-JA25 / SN-JA30 standard + custom concentration / particle size / stabilizer", jaDesc: "SN-JA25 / SN-JA30 標準 + 濃度・粒子径・安定剤カスタム" },
  ],
  specs: [
    { label: "제품 라인업", value: "SN-JA25 / SN-JA30 (신형·NH₃ 안정형)", enValue: "SN-JA25 / SN-JA30 (New Type · NH₃-stabilized)", jaValue: "SN-JA25 / SN-JA30 (新型・NH₃安定型)", enLabel: "Product Lineup", jaLabel: "製品ラインアップ" },
  ...
  subModels: [
    { code: "SN-JA25", slug: "sl-ja25", spec: "SiO₂ 25~26% · 10~12 nm · NH₃ 안정형", enSpec: "SiO₂ 25–26% · 10–12 nm · NH₃-stabilized", jaSpec: "SiO₂ 25~26% · 10~12 nm · NH₃安定型", name: "SN-JA25 실리카졸", enName: "SN-JA25 · Silica Sol", jaName: "SN-JA25 シリカゾル" },
    { code: "SN-JA30", slug: "sl-ja30", spec: "SiO₂ 30~31% · 10~11.5 nm · NH₃ 안정형", enSpec: "SiO₂ 30–31% · 10–11.5 nm · NH₃-stabilized", jaSpec: "SiO₂ 30~31% · 10~11.5 nm · NH₃安定型", name: "SN-JA30 실리카졸", enName: "SN-JA30 · Silica Sol", jaName: "SN-JA30 シリカゾル" },
    { code: "SN-SHS", slug: "sl-shs", spec: "14종 그레이드 · JN/SW/JA/ZX/JGC 시리즈 · 6~30 nm", enSpec: "14-grade lineup · JN/SW/JA/ZX/JGC series · 6–30 nm", jaSpec: "14グレード · JN/SW/JA/ZX/JGC シリーズ · 6~30 nm", name: "콜로이달 실리카 시리즈", enName: "Colloidal Silica Full Series", jaName: "コロイダルシリカ シリーズ" },
  ],
...
const silicaSolChildren: ProductDetail[] = [
  {
    slug: "sl-ja25",
    name: "SN-JA25 실리카졸",
    enName: "SN-JA25 · Silica Sol (New Type)",
    jaName: "SN-JA25 シリカゾル (新型)",
    ...
    description:
      "SN-JA25는 SiO₂ 25~26% 농도, 평균 입경 10~12 nm의 암모니아(NH₃) 안정형 신형 콜로이달 실리카입니다. 낮은 알칼리(Na₂O ≤ 0.03%)와 우수한 콜로이드 안정성을 바탕으로 정밀 주조 셸 몰드 바인더, 내화 도료, 세라믹 코팅, 촉매 담체, 리튬 이차전지 세라믹 세퍼레이터 코팅 등 저 이온·저 잔류물이 요구되는 응용에 최적화된 표준 그레이드입니다.",
    enDescription:
      "SN-JA25 is an ammonia (NH₃) stabilized New-Type colloidal silica with SiO₂ 25–26% and a mean particle size of 10–12 nm. With low alkali (Na₂O ≤ 0.03%) and excellent colloidal stability, it is the standard grade for applications requiring low ionic content and low residue — investment-casting shell binders, refractory paints, ceramic coatings, catalyst supports and ceramic-coated separators for lithium-ion batteries.",
    jaDescription:
      "SN-JA25はSiO₂ 25~26%、平均粒子径10~12 nmのアンモニア(NH₃)安定型・新型コロイダルシリカです。低アルカリ(Na₂O ≤ 0.03%)と優れたコロイド安定性を活かし、精密鋳造シェルバインダー、耐火塗料、セラミックコーティング、触媒担体、リチウム二次電池のセラミックセパレーターコーティングなど低イオン・低残留物が求められる用途に最適な標準グレードです。",
    image: silicaSolImg,
    detailImage: silicaSolImg,
    category: "quartz",
    ...
    specs: [
      { label: "제품 코드", value: "SN-JA25", enLabel: "Product Code", jaLabel: "製品コード" },
  ...
  },
  {
    slug: "sl-ja30",
    name: "SN-JA30 실리카졸",
    enName: "SN-JA30 · Silica Sol (New Type)",
    jaName: "SN-JA30 シリカゾル (新型)",
    ...
    description:
      "SN-JA30은 SiO₂ 30~31% 고농도, 평균 입경 10~11.5 nm의 암모니아(NH₃) 안정형 신형 콜로이달 실리카로, 비표면적 198~258 m²/g 수준의 초미립 나노 입자를 균일하게 분산시킨 유백색 반투명 콜로이드 액입니다. 고농도 SiO₂ 특성 덕분에 동일 사용량 대비 더 강한 결합력·소결 강도를 확보할 수 있어 정밀 주조 셸 몰드, 내화 코팅, 세라믹 결합제, 촉매 담체, 이차전지 세라믹 세퍼레이터 코팅, CMP 슬러리 원료 등 고성능이 요구되는 응용에 특히 적합합니다.",
    enDescription:
      "SN-JA30 is an ammonia (NH₃) stabilized New-Type colloidal silica with high SiO₂ content of 30–31% and a mean particle size of 10–11.5 nm. Its ultrafine nanoparticles (SSA 198–258 m²/g) are uniformly dispersed in water as a milky-white translucent colloid. The higher SiO₂ concentration delivers greater binding force and sintering strength per unit dose, making SN-JA30 particularly suitable for investment-casting shell molds, refractory coatings, ceramic binders, catalyst supports, ceramic-coated separators for secondary batteries and CMP slurry feedstock.",
    jaDescription:
      "SN-JA30はSiO₂ 30~31%の高濃度、平均粒子径10~11.5 nmのアンモニア(NH₃)安定型・新型コロイダルシリカで、比表面積198~258 m²/gの超微粒ナノ粒子を均一に分散させた乳白色半透明のコロイド液です。高濃度SiO₂により同量使用時により強い結合力・焼結強度を確保でき、精密鋳造シェルバインダー、耐火コーティング、セラミック結合剤、触媒担体、二次電池セラミックセパレーターコーティング、CMPスラリー原料など高性能が求められる用途に特に適します。",
    image: silicaSolImg,
    detailImage: silicaSolImg,
    category: "quartz",
    parentSlug: "silica-sol",
    ...
    specs: [
      { label: "제품 코드", value: "SN-JA30", enLabel: "Product Code", jaLabel: "製品コード" },
      { label: "타입", value: "신형 (New Type) · NH₃ 안정형", enValue: "New Type · NH₃-stabilized", jaValue: "新型 (New Type) · NH₃安定型", enLabel: "Type", jaLabel: "タイプ" },
      { label: "외관", value: "유백색 반투명 콜로이드 액", enValue: "Milky-white translucent colloidal liquid", jaValue: "乳白色半透明のコロイド液", enLabel: "Appearance", jaLabel: "外観" },
  ...
  },
  {
    ...
    specs: [
      { label: "제품 코드", value: "SN-SHS 시리즈", enValue: "SN-SHS Series", jaValue: "SN-SHS シリーズ", enLabel: "Product Code", jaLabel: "製品コード" },
...
const precipitatedExtProducts: ProductDetail[] = [
  // 소광제 (도료·코팅용)
  mkPS("SN-CT-102", "침전 실리카 (도료 소광 · 초미세 겸용)", "Precipitated Silica (Matting & Ultrafine Dual-Use)", "沈降シリカ(艶消し・超微粒兼用)",
    ...
    "SN-CT-102는 도료·잉크의 소광제와 초미세 이산화규소 두 용도를 겸비한 침전 실리카입니다. 5μm 평균 입경과 230–260 m²/g의 높은 비표면적, 1.4–1.5 ml/g의 공극 부피로 일반 장식페인트·목재·가구·분체도료의 소광 효과와 필름 형성 후 매끄러운 촉감을 동시에 구현합니다. SiO₂ 98.5% · 중성 pH(6.9–7.1)로 유·수성 도료 시스템 모두에서 안정적으로 분산됩니다.",
    "SN-CT-102 is a precipitated silica that combines paint/ink matting and general ultrafine SiO₂ functions. With an average particle size of 5 μm, high BET (230–260 m²/g) and 1.4–1.5 ml/g pore volume, it delivers matting and smooth-touch finishes in decorative, wood, furniture and powder coatings. SiO₂ 98.5% with neutral pH (6.9–7.1) enables stable dispersion in both solvent- and water-based systems.",
    "SN-CT-102は塗料・インキ用艶消し剤と超微細二酸化ケイ素の両用途を兼備した沈降シリカです。平均粒径5μm、BET 230–260 m²/g、細孔容積1.4–1.5 ml/gにより、装飾塗料・木材・家具・粉体塗料での艶消し効果と滑らかな仕上がりを同時に実現します。SiO₂ 98.5%・中性pH(6.9–7.1)で油性・水性塗料に安定分散します。",
    [
  ...
  mkPS("SN-CT-107", "침전 실리카 (도료 소광 · 젤법)", "Precipitated Silica Matting Agent (Gel Method)", "沈降シリカ 艶消し剤(ゲル法)",
    ...
    "SN-CT-107은 젤법으로 제조된 백색 침전 실리카 소광제입니다. 280 m²/g의 비표면적, DBP 360–400, 1.8 ml/g의 대공극 구조로 가구·목재·권강페인트에서 우수한 소광 성능과 부드러운 촉감을 동시에 제공합니다. 5μm 평균 입경으로 필름 표면 요철을 미세하게 형성해 눈부심 없는 무광 마감을 완성합니다.",
    "SN-CT-107 is a gel-method white precipitated silica matting agent. Its 280 m²/g surface area, DBP 360–400 and 1.8 ml/g high pore volume deliver strong matting and smooth touch in furniture, wood and coil coatings. The 5 μm average particle creates a fine micro-texture that produces glare-free matte finishes.",
    "SN-CT-107はゲル法で製造された白色沈降シリカ艶消し剤です。BET 280 m²/g、DBP 360–400、細孔容積1.8 ml/gの構造で家具・木材・コイル塗料に優れた艶消し性能と滑らかな触感を提供します。平均粒径5μmが微細な表面凹凸を形成し、まぶしさのないマット仕上げを実現します。",
    [
  ...
  mkPS("SN-CT-1031", "침전 실리카 (도료 소광 · 잉크 흡착)", "Precipitated Silica (Matting & Ink Absorbing)", "沈降シリカ(艶消し・インキ吸着)",
    ...
    "SN-CT-1031은 3μm 급 미세 입도와 DBP 340–380의 높은 흡유량으로 도료 소광과 인화지·잉크 흡착을 동시에 만족시키는 다기능 침전 실리카입니다. 98.6%의 SiO₂ 순도와 중성 pH로 유성·수성 시스템 모두에서 안정적으로 사용되며, 잉크젯 코팅·고흡착 도료·특수 인쇄용지에 최적화되어 있습니다.",
    "SN-CT-1031 delivers dual matting and ink/paper absorption performance with 3 μm fine particles and high DBP (340–380). SiO₂ 98.6% and neutral pH make it compatible with solvent- and water-based systems, optimized for inkjet coatings, high-absorption paints and specialty printing papers.",
    "SN-CT-1031は3μm級の微細粒度とDBP 340–380の高吸油量で塗料艶消しと印刷紙・インキ吸着を同時に満たす多機能沈降シリカです。SiO₂ 98.6%・中性pHで油性・水性系に安定使用でき、インクジェットコーティング・高吸着塗料・特殊印刷紙に最適化されています。",
    [
      { label: "외관", value: "백색 분말" },
  ...
  mkPS("SN-CT-104", "침전 실리카 (도료 소광 · 실리콘고무 겸용)", "Precipitated Silica (Matting & Silicone Rubber Dual-Use)", "沈降シリカ(艶消し・シリコーンゴム兼用)",
    ...
    "SN-CT-104는 도료용 등급(SiO₂ 98.6%)과 고무용 등급(SiO₂ 99.8%)이 함께 제공되는 이중 용도 침전 실리카입니다. BET 200 / 185 m²/g 수준으로 고급 유성도료·잉크의 소광 성능과 실리콘고무·엘라스토머의 인장·인열·경도 보강을 동시에 만족합니다. D50 3–4μm의 미세 입자로 매끄러운 마감과 균일 분산을 제공합니다.",
    "SN-CT-104 is a dual-purpose precipitated silica offered in a paint grade (SiO₂ 98.6%) and a silicone rubber grade (SiO₂ 99.8%). BET 200 / 185 m²/g simultaneously meets matting requirements for premium solvent paints/inks and reinforcement (tensile, tear, hardness) for silicone rubber. D50 3–4 μm delivers smooth finishes and uniform dispersion.",
    "SN-CT-104は塗料用グレード(SiO₂ 98.6%)とゴム用グレード(SiO₂ 99.8%)が提供されるデュアル用途の沈降シリカです。BET 200 / 185 m²/gで高級油性塗料・インキの艶消しとシリコーンゴム・エラストマーの引張・引裂・硬度補強を同時に実現。D50 3–4μmで滑らかな仕上がりと均一分散を提供します。",
    [
      { label: "외관", value: "백색 분말" },
  ...
  mkPS("SN-CT-107L", "침전 실리카 (유기 표면처리 소광제)", "Precipitated Silica (Organic Surface-Treated Matting Agent)", "沈降シリカ(有機表面処理艶消し剤)",
    ...
    "SN-CT-107L은 표면을 유기 처리한 고순도(99.9%) 침전 실리카로, 320 m²/g의 초고비표면적과 DBP 400의 대흡유량, 1.8 ml/g의 대공극을 갖춘 프리미엄 소광제입니다. 고급 가구도료·무광 자동차 클리어·가죽 조제·광택유 등 최고 등급 마감이 요구되는 분야에 사용되며, 유기 처리로 유성 시스템에서의 침강 방지 및 재분산성이 우수합니다.",
    "SN-CT-107L is an organically surface-treated high-purity (99.9%) precipitated silica — a premium matting agent with ultra-high 320 m²/g BET, DBP 400 and 1.8 ml/g pore volume. Designed for premium furniture coatings, matte automotive clears, leather chemicals and polish oils, its organic treatment provides excellent anti-settling and redispersibility in solvent systems.",
    "SN-CT-107Lは表面を有機処理した高純度(99.9%)沈降シリカで、BET 320 m²/g、DBP 400、細孔容積1.8 ml/gの超高性能艶消し剤です。高級家具塗料・マット自動車クリア・皮革薬剤・光沢油など最高級仕上げに使用され、有機処理により油性系での沈降防止・再分散性に優れます。",
    [
  ...
  // 초미세 이산화규소 (범용 보강·증점)
  mkPS("SN-CT-101", "초미세 침전 실리카", "Ultrafine Precipitated Silica", "超微細沈降シリカ",
    ...
    "SN-CT-101은 실리콘고무·유성 도료·1액형 접착제 등에서 널리 쓰이는 범용 초미세 침전 실리카입니다. BET 185–205 m²/g, 흡유값 2.3–2.8 cm³/g로 안정된 보강·증점·요변성을 제공하며, 8–10μm의 균일 입자로 배합 안정성과 취급성이 우수합니다.",
    "SN-CT-101 is a general-purpose ultrafine precipitated silica widely used in silicone rubber, solvent-borne paints and one-part adhesives. BET 185–205 m²/g and oil absorption 2.3–2.8 cm³/g provide stable reinforcement, thickening and thixotropy; 8–10 μm particles ensure formulation stability and easy handling.",
    "SN-CT-101はシリコーンゴム・油性塗料・1液型接着剤で広く使用される汎用超微細沈降シリカです。BET 185–205 m²/g、吸油値2.3–2.8 cm³/gで安定した補強・増粘・チキソ性を提供し、8–10μmの均一粒子で配合安定性と取り扱い性に優れます。",
    [
      { label: "SiO₂", value: "98 %" },
  ...
  mkPS("SN-CT-101AH", "초미세 침전 실리카", "Ultrafine Precipitated Silica", "超微細沈降シリカ",
    ...
    "SN-CT-101AH는 SN-CT-101과 동일 계열의 초미세 침전 실리카로, 흡유값과 입도가 유사하면서도 배치 간 편차가 낮게 관리된 고안정성 등급입니다. 실리콘고무의 인장 강도·경도 부여, 유성 도료·잉크의 침강 방지·증점, RTV/1액형 접착제의 요변성 개선에 폭넓게 적용됩니다.",
    "SN-CT-101AH is an ultrafine precipitated silica in the same family as SN-CT-101, offering a high-stability grade with tightly controlled batch-to-batch variation. Broadly used for tensile/hardness reinforcement in silicone rubber, anti-settling and thickening in solvent paints/inks, and thixotropy in RTV and one-part adhesives.",
    "SN-CT-101AHはSN-CT-101と同系列の超微細沈降シリカで、吸油値と粒度は同等ながらバッチ間ばらつきを抑えた高安定グレードです。シリコーンゴムの引張強度・硬度付与、油性塗料・インキの沈降防止・増粘、RTV/1液型接着剤のチキソ性改善に幅広く適用されます。",
    [
      { label: "SiO₂", value: "98 %" },
  ...
  mkPS("SN-CT-99", "초미세 침전 실리카", "Ultrafine Precipitated Silica", "超微細沈降シリカ",
    "45–70μm 조립형 · 취급 용이한 저비산 범용 실리카",
    "45–70 μm coarse grade — easy-to-handle, low-dust general silica",
    "45–70μm 粗粒型・取り扱い容易な低飛散汎用シリカ",
    "SN-CT-99는 평균 45–70μm의 조립형 침전 실리카로, 자동 계량·투입 라인에서 비산이 매우 적고 흐름성이 우수합니다. SiO₂ 96% · BET 165–200 m²/g · 흡유값 2.0–3.5 cm³/g로 범용 고무 보강·페인트 증점·접착제 필러 용도에 경제적으로 활용됩니다.",
    "SN-CT-99 is a coarse (45–70 μm) precipitated silica with very low dust and excellent flow in automatic weighing lines. SiO₂ 96%, BET 165–200 m²/g and oil absorption 2.0–3.5 cm³/g make it an economical choice for general rubber reinforcement, paint thickening and adhesive fillers.",
    "SN-CT-99は平均45–70μmの粗粒型沈降シリカで、自動計量・投入ラインでの飛散が非常に少なく流動性に優れます。SiO₂ 96%、BET 165–200 m²/g、吸油値2.0–3.5 cm³/gで汎用ゴム補強・塗料増粘・接着剤フィラーに経済的です。",
    [
      { label: "SiO₂", value: "96 %" },
  ...
  mkPS("SN-CT-103", "초미세 침전 실리카 (고비표면적)", "Ultrafine Precipitated Silica (High SSA)", "超微細沈降シリカ(高比表面積)",
    ...
    "SN-CT-103은 BET 240–380 m²/g의 초고비표면적을 갖춘 침전 실리카로, 소량 첨가로 강한 보강·증점 효과가 필요한 실리콘 고무·특수 접착제·프리미엄 도료에 적합합니다. 흡유값 3.0–4.0 cm³/g로 대량의 오일·수지를 흡수하여 요변성·처짐 방지 기능을 부여합니다.",
    "SN-CT-103 is a precipitated silica with ultra-high BET 240–380 m²/g, suitable for silicone rubber, specialty adhesives and premium coatings requiring strong reinforcement and thickening at low loadings. Oil absorption 3.0–4.0 cm³/g absorbs large amounts of oil/resin to impart thixotropy and anti-sagging.",
    "SN-CT-103はBET 240–380 m²/gの超高比表面積を持つ沈降シリカで、少量添加で強い補強・増粘効果を要するシリコーンゴム・特殊接着剤・プレミアム塗料に適合。吸油値3.0–4.0 cm³/gで大量のオイル・樹脂を吸収し、チキソ性と液だれ防止性を付与します。",
    [
      { label: "SiO₂", value: "98 %" },
  ...
  // 담체·충전재용
  mkPS("SN-CT-601", "담체·충전재용 침전 실리카", "Precipitated Silica Carrier / Filler", "担体・充填剤用沈降シリカ",
    ...
    "SN-CT-601은 45μm 조립·다공성 침전 실리카로, 사료 첨가제·농약 원제·도자기 유약의 담체(carrier) 및 충전재로 사용됩니다. 220–250 m²/g의 높은 비표면적과 DBP 310–370의 흡유량이 유효 성분의 균일한 담지와 서방출 효과를 부여하며, 취급성이 우수한 조립형입니다.",
    "SN-CT-601 is a 45 μm porous precipitated silica used as a carrier and filler for feed additives, agrochemical actives and ceramic glazes. Its 220–250 m²/g BET and 310–370 DBP provide uniform loading and controlled release of actives while offering easy-handling coarse morphology.",
    "SN-CT-601は45μm粗粒・多孔性の沈降シリカで、飼料添加剤・農薬原体・陶磁器釉薬の担体(carrier)および充填剤として使用されます。BET 220–250 m²/g、DBP 310–370により有効成分の均一担持と徐放効果を付与し、取り扱い性に優れる粗粒型です。",
    [
  ...
  mkPS("SN-CT-602", "담체·충전재용 침전 실리카", "Precipitated Silica Carrier / Filler", "担体・充填剤用沈降シリカ",
    ...
    "SN-CT-602는 6μm의 미세 입도를 가진 담체·충전재용 침전 실리카로, 유효 성분의 정밀 담지, 균일 분산과 함께 우수한 흡유·흡습 기능을 제공합니다. 사료·프리믹스·수용성 농약·유약 안료 분산에 최적화되어 있습니다.",
    "SN-CT-602 is a fine (6 μm) carrier/filler precipitated silica delivering precise active loading, uniform dispersion and strong oil/moisture absorption. Optimized for feed premixes, water-soluble agrochemicals and glaze pigment dispersion.",
    "SN-CT-602は6μmの微細粒度を持つ担体・充填剤用沈降シリカで、有効成分の精密担持・均一分散と優れた吸油・吸湿機能を提供します。飼料プレミックス・水溶性農薬・釉薬顔料分散に最適化されています。",
    [
      { label: "SiO₂(건품)", value: "93.0–99.0 %" },
      { label: "pH", value: "6.8–7.0" },
  ...
  // 실리콘고무 보강용
  mkPS("SN-CT-30", "실리콘고무 보강용 침전 실리카", "Silicone Rubber Reinforcement Silica", "シリコーンゴム補強用沈降シリカ",
    ...
    "SN-CT-30은 실리콘 고무 전용으로 개발된 침전 실리카로, BET 120–170 m²/g의 중간 비표면적과 260 ml/100g의 DBP로 안정된 보강 성능을 제공합니다. SiO₂ ≥ 98%, pH ≥ 7의 저이온 등급으로 투명·반투명 실리콘고무 제품(케이블, 의료 튜브, 케이스류)의 광학적 특성과 물성을 동시에 만족시킵니다.",
    "SN-CT-30 is a precipitated silica developed for silicone rubber, offering stable reinforcement with BET 120–170 m²/g and 260 ml/100g DBP. SiO₂ ≥ 98% and pH ≥ 7 low-ionic grade satisfies both optical clarity and mechanical properties in transparent/semi-transparent silicone products (cables, medical tubing, cases).",
    "SN-CT-30はシリコーンゴム専用に開発された沈降シリカで、BET 120–170 m²/g、DBP 260 ml/100gで安定した補強性能を提供します。SiO₂ ≥ 98%、pH ≥ 7の低イオングレードで透明・半透明シリコーン製品(ケーブル、医療チューブ、ケース類)の光学特性と物性を同時に満たします。",
    [
      { label: "SiO₂", value: "≥ 98 %" },
      { label: "pH", value: "≥ 7" },
  ...
  // 기능성 마스터배치용
  mkPS("SN-CT-MB-107", "기능성 마스터배치용 침전 실리카", "Functional Masterbatch Silica", "機能性マスターバッチ用沈降シリカ",
    ...
    "SN-CT-MB-107은 PP·PE 필름·시트용 기능성 마스터배치 전용 침전 실리카입니다. SiO₂ ≥ 99% 고순도, BET 280–300 m²/g, DBP 170–180, <5μm의 미세 입도로 안티블로킹·매트·투명 필름 개질에 최적화되어 있으며, 수지 내 균일 분산과 낮은 겔·이물 발생률을 보장합니다.",
    "SN-CT-MB-107 is a functional-masterbatch precipitated silica dedicated to PP/PE films and sheets. SiO₂ ≥ 99% high purity, BET 280–300 m²/g, DBP 170–180 and <5 μm fine particles are optimized for anti-blocking, matte and transparent film modification, guaranteeing uniform dispersion and low gel/defect rates.",
    "SN-CT-MB-107はPP・PEフィルム・シート用機能性マスターバッチ専用の沈降シリカです。SiO₂ ≥ 99%高純度、BET 280–300 m²/g、DBP 170–180、<5μmの微細粒度でアンチブロッキング・マット・透明フィルム改質に最適化されており、樹脂内均一分散と低ゲル・欠陥率を保証します。",
    [
      { label: "외관", value: "백색 분말" },
      { label: "SiO₂", value: "≥ 99 %" },
      { label: "pH", value: "6.5–7.5" },
  ...
  // 일반 이산화규소 (백탄흑 · 고무보강)
  mkPS("SN-CT-199", "타이어·고무 보강용 백탄흑 (침전 실리카)", "White Carbon Black — Tire/Rubber Reinforcement", "白炭黒 — タイヤ・ゴム補強用",
    ...
    "SN-CT-199는 타이어·산업용 고무의 표준 보강용 백탄흑(침전 실리카)입니다. BET 220–280 m²/g의 고비표면적과 DBP 300–370의 대구조 특성으로 인장·인열 강도와 마모성을 크게 향상시키며, 그린타이어(연비 저감형)의 저저항·저발열 특성 구현에 핵심 소재로 사용됩니다.",
    "SN-CT-199 is a standard white carbon black (precipitated silica) for tire and industrial rubber reinforcement. BET 220–280 m²/g and 300–370 DBP significantly improve tensile/tear strength and abrasion, and it is a key material for green (low-rolling-resistance, low-heat-buildup) tires.",
    "SN-CT-199はタイヤ・産業用ゴムの標準補強用白炭黒(沈降シリカ)です。BET 220–280 m²/gの高比表面積とDBP 300–370の大構造特性で引張・引裂強度と耐摩耗性を大幅に向上させ、グリーンタイヤ(低燃費型)の低抵抗・低発熱化に核心素材として使用されます。",
    [
  ...
  mkPS("SN-CT-299", "타이어·고무 보강용 백탄흑 (침전 실리카)", "White Carbon Black — Tire/Rubber Reinforcement", "白炭黒 — タイヤ・ゴム補強用",
    ...
    "SN-CT-299는 SN-CT-199 대비 중간 비표면적을 가진 경제형 백탄흑입니다. 200 mesh 조립 입도로 취급이 용이하며, 신발 밑창·산업용 벨트·컨베이어·호스 등 중강도 고무 제품에 폭넓게 적용됩니다.",
    "SN-CT-299 is an economical white carbon black with medium BET compared to SN-CT-199. 200 mesh coarse particles make it easy to handle and broadly applicable to shoe soles, industrial belts, conveyors and hoses.",
    "SN-CT-299はSN-CT-199に比べ中間比表面積の経済型白炭黒です。200 mesh粗粒で取り扱いやすく、靴底・産業ベルト・コンベア・ホースなど中強度ゴム製品に幅広く適用されます。",
    [
  ...
  // 소수성 백탄흑
  mkPS("SN-CT-HPB-001", "소수성 백탄흑 (침전법)", "Hydrophobic White Carbon Black (Precipitation)", "疎水性白炭黒(沈降法)",
    ...
    "SN-CT-HPB-001은 침전법으로 제조된 백탄흑을 실란/실록산으로 표면 소수화 처리한 등급으로, 유성 도료·잉크·실리콘 고무 등 비극성 매체에서 우수한 분산성과 침강 방지 효과를 나타냅니다. 상세 스펙은 요청 시 시트로 제공합니다.",
    "SN-CT-HPB-001 is a precipitated white carbon black surface-hydrophobized with silane/siloxane, providing excellent dispersion and anti-settling in non-polar media such as solvent paints, inks and silicone rubber. Detailed spec sheet available on request.",
    "SN-CT-HPB-001は沈降法白炭黒をシラン/シロキサンで疎水化処理したグレードで、油性塗料・インキ・シリコーンゴムなど非極性媒体で優れた分散性と沈降防止効果を示します。詳細スペックは要請時にシートで提供します。",
    [
  ...
  mkPS("SN-CT-HPB-002", "소수성 나노 백탄흑 (졸-겔법)", "Hydrophobic Nano White Carbon Black (Sol-Gel)", "疎水性ナノ白炭黒(ゾル-ゲル法)",
    "졸-겔법 나노 콜로이드 실리카 · 입경 <100 nm",
    "Sol-gel colloidal nano silica with particle size <100 nm",
    "ゾル-ゲル法によるナノコロイダルシリカ · 粒径<100 nm",
    "SN-CT-HPB-002는 졸-겔(Sol-Gel)법으로 제조된 투명 콜로이드 나노 입자(입경 100 nm 이하) 소수성 실리카입니다. 고급 잉크·투명 코팅·전자 소재의 나노 필러로 활용되며, 상세 스펙은 요청 시 시트로 제공합니다.",
    "SN-CT-HPB-002 is a hydrophobic silica composed of transparent colloidal nanoparticles (<100 nm) produced by the sol-gel method. Used as a nano filler in premium inks, transparent coatings and electronic materials. Detailed spec sheet available on request.",
    "SN-CT-HPB-002はゾル-ゲル(Sol-Gel)法で製造された透明コロイダルナノ粒子(粒径100 nm以下)の疎水性シリカです。高級インキ・透明コーティング・電子素材のナノフィラーとして活用され、詳細スペックは要請時にシートで提供します。",
    [
  ...
  mkPS("SN-DF-010", "소포제용 고소수성 침전 실리카", "Hydrophobic Silica for Defoamer", "消泡剤用高疎水性沈降シリカ",
    ...
    "SN-DF-010은 광유·실리콘오일 기반 산업용 소포제 전용으로 개발된 고소수성 침전 실리카입니다. 광유 기반 소포제에서 소포 효율을 3~5배, 실리콘오일 기반에서 약 2배 개선하며, 강산·강알칼리 환경에서도 안정적으로 작동하는 것이 특징입니다.",
    "SN-DF-010 is a highly hydrophobic precipitated silica developed exclusively for mineral- and silicone-oil based industrial defoamers. It improves defoaming efficiency 3–5× in mineral-oil defoamers and ~2× in silicone-oil defoamers, and remains stable under strong acid/alkali environments.",
    "SN-DF-010は鉱油・シリコーンオイル系産業用消泡剤専用に開発された高疎水性沈降シリカです。鉱油系消泡剤で消泡効率を3~5倍、シリコーンオイル系で約2倍改善し、強酸・強アルカリ環境でも安定作動するのが特徴です。",
    [
  ...
  // 식품·사료·특수 용도
  mkPS("SN-FGD-001", "식품첨가물용 침전 실리카 (고결방지제)", "Food-Grade Precipitated Silica (Anti-Caking)", "食品添加物用沈降シリカ(固結防止剤)",
    ...
    "SN-FGD-001은 중국 식품안전 국가표준 GB 25576-2020에 부합하는 식품첨가물용 침전 실리카(고결방지제)입니다. Pb·As·중금속을 극도로 낮게 관리하여 조미료·분유·인스턴트 커피·시리얼·건강기능식품 등 다양한 식품에서 안전한 고결 방지·자유 흐름 효과를 제공합니다.",
    "SN-FGD-001 is a food-additive precipitated silica (anti-caking agent) compliant with China's GB 25576-2020 food-safety standard. Ultra-low Pb/As/heavy metals ensure safe anti-caking and free-flow performance in seasonings, milk powder, instant coffee, cereals and functional foods.",
    "SN-FGD-001は中国食品安全国家規格GB 25576-2020に適合する食品添加物用沈降シリカ(固結防止剤)です。Pb・As・重金属を極めて低く管理し、調味料・粉ミルク・インスタントコーヒー・シリアル・機能性食品に安全な固結防止・流動性付与効果を提供します。",
    [
  ...
  mkPS("SN-TPS-001", "치약용 침전 실리카 (증점형)", "Toothpaste Silica (Thickening Type)", "歯磨き粉用沈降シリカ(増粘型)",
    "치약 페이스트 증점·구조 형성용 고흡수 실리카",
    "High-absorption silica for toothpaste paste thickening and structure",
    "歯磨きペーストの増粘・構造形成用の高吸収シリカ",
    "SN-TPS-001은 치약 페이스트의 증점(Thickening)과 요변성 부여를 담당하는 실리카로, 320목 이상의 미세 입도와 17~20 ml/20g의 흡수량으로 안정된 겔 구조를 형성합니다. 굴절률(1.435–1.460)이 치약 매트릭스와 일치하여 투명·반투명 치약 제형에 최적입니다.",
    "SN-TPS-001 is a thickening/thixotropic silica for toothpaste. Fine 320-mesh particles and 17–20 ml/20g absorption form a stable gel structure, and its refractive index (1.435–1.460) matches the toothpaste matrix, ideal for transparent and translucent pastes.",
    "SN-TPS-001は歯磨きペーストの増粘(Thickening)とチキソ性付与を担うシリカで、320メッシュ以上の微細粒度と17~20 ml/20gの吸収量で安定したゲル構造を形成します。屈折率(1.435–1.460)が歯磨きマトリックスと一致し、透明・半透明ペーストに最適です。",
    [
  ...
  mkPS("SN-TPS-002", "치약용 침전 실리카 (마찰형)", "Toothpaste Silica (Abrasive Type)", "歯磨き粉用沈降シリカ(研磨型)",
    "적절한 RDA·부드러운 세정력의 치약 연마 실리카",
    "Toothpaste abrasive silica with appropriate RDA and gentle cleaning",
    "適切なRDA・優しい洗浄力の歯磨き研磨シリカ",
    "SN-TPS-002는 치약의 마찰·연마(Abrasive)를 담당하는 실리카로, 30–42 ml/20g의 중간 흡수량과 엄격히 관리된 입도로 부드러운 세정력을 유지하면서 치아 에나멜 손상을 최소화합니다. 굴절률과 pH가 조정되어 있어 안정된 페이스트를 형성합니다.",
    "SN-TPS-002 is an abrasive silica for toothpaste, with medium 30–42 ml/20g absorption and tightly controlled particle size that delivers gentle cleaning while minimizing enamel damage. Its refractive index and pH are tuned for stable paste formation.",
    "SN-TPS-002は歯磨きの摩擦・研磨(Abrasive)を担うシリカで、30–42 ml/20gの中間吸収量と厳密管理された粒度で優しい洗浄力を維持しつつエナメル質損傷を最小化します。屈折率とpHが調整され安定したペーストを形成します。",
    [
      { label: "pH(5%)", value: "6.5–8.5" },
      { label: "세도(320목 통과)", value: "≥ 98 %" },
      { label: "SiO₂", value: "≥ 96 %" },
  ...
  mkPS("SN-TPS-003", "치약용 침전 실리카 (증점+연마 혼합형)", "Toothpaste Silica (Thickening + Abrasive Hybrid)", "歯磨き粉用沈降シリカ(増粘+研磨複合型)",
    "증점과 연마를 동시에 만족하는 통합형 치약 실리카",
    "Hybrid silica delivering both thickening and abrasion in a single grade",
    "増粘と研磨を同時に満たす統合型歯磨きシリカ",
    "SN-TPS-003은 치약의 증점과 연마 기능을 단일 등급으로 통합한 실리카입니다. 54–60 ml/20g의 높은 흡수량과 0.15–0.20 g/ml의 저밀도로 페이스트의 볼륨감·부드러운 사용감을 부여하면서도 적절한 연마 성능을 보유합니다.",
    "SN-TPS-003 combines thickening and abrasion in a single toothpaste silica. Its high 54–60 ml/20g absorption and 0.15–0.20 g/ml low density provide paste volume and smooth feel while retaining appropriate abrasion.",
    "SN-TPS-003は歯磨きの増粘と研磨機能を単一グレードに統合したシリカです。54–60 ml/20gの高吸収量と0.15–0.20 g/mlの低密度でペーストのボリューム感と滑らかな使用感を付与しつつ、適切な研磨性能を保持します。",
    [
  ...
  mkPS("SN-ADH-001", "접착제용 백탄흑 (침전 실리카)", "White Carbon Black for Adhesives", "接着剤用白炭黒",
    ...
    "SN-ADH-001은 유리 실란트·건축용 실리콘·AB형 에폭시 접착제 등 프리미엄 접착제 전용으로 개발된 침전 실리카입니다. BET 260 m²/g 이상, DBP 380의 대구조 특성으로 강력한 요변성과 처짐 방지, 접착 강도 향상을 동시에 부여합니다.",
    "SN-ADH-001 is a precipitated silica developed for premium adhesives such as glazing sealants, architectural silicones and AB epoxy adhesives. BET ≥ 260 m²/g and DBP 380 deliver strong thixotropy, anti-sagging and improved bond strength.",
    "SN-ADH-001はガラスシーラント・建築用シリコーン・AB型エポキシ接着剤などプレミアム接着剤専用に開発された沈降シリカです。BET 260 m²/g以上、DBP 380の大構造特性で強力なチキソ性と液だれ防止、接着強度向上を同時に付与します。",
    [
  ...
  mkPS("SN-INR-001", "식품급 불활성분 (곡물 저장 방충용)", "Food-Grade Inert Powder (Grain Storage Insect Control)", "食品級不活性粉末(穀物保管防虫用)",
    "화학 방제제 없이 물리적 방식으로 해충 방제 · 식품안전기준 부합",
    "Physical (not chemical) insect control — food-safety compliant",
    "化学薬剤不使用、物理的防虫 · 食品安全基準適合",
    "SN-INR-001은 곡물·저장 사료의 방충용으로 사용되는 식품급 불활성 실리카 분말입니다. 화학 방제제 없이 곤충 표피의 왁스층에 미세 상처를 내어 탈수·사멸을 유도하는 물리적 방제 방식으로, 잔류·독성 우려가 없으며 식품안전기준에 부합합니다.",
    "SN-INR-001 is a food-grade inert silica powder for insect control in stored grain and feed. It works physically by scratching the wax cuticle of insects to cause dehydration — no chemical residues or toxicity, fully compliant with food-safety standards.",
    "SN-INR-001は穀物・貯蔵飼料の防虫用に使用される食品級不活性シリカ粉末です。化学薬剤を使わず、昆虫表皮のワックス層に微細な傷をつけて脱水・致死させる物理的防除方式で、残留・毒性の懸念がなく食品安全基準に適合します。",
    [
  ...
  mkPS("SN-VET-001", "수의약품용 건조분말", "Veterinary-Use Drying Powder", "動物薬用乾燥粉末",
    ...
    "SN-VET-001은 항생제·비타민·중초약(中草藥) 등 수용성 동물약품의 제립·건조·저장 공정에서 사용되는 침전 실리카 기반 건조분말입니다. 우수한 흡습·항결 특성으로 제립 건조 시간을 약 2/3 수준으로 단축시키며, 최종 제제의 유동성과 저장 안정성을 향상시킵니다.",
    "SN-VET-001 is a precipitated-silica drying powder used in granulation, drying and storage of water-soluble veterinary drugs such as antibiotics, vitamins and Chinese herbal medicines. Strong moisture absorption and anti-caking properties cut granulation drying time to about 1/3, and improve flowability and storage stability of the final product.",
    "SN-VET-001は抗生物質・ビタミン・中草薬など水溶性動物薬品の造粒・乾燥・貯蔵工程で使用される沈降シリカ系乾燥粉末です。優れた吸湿・固結防止特性で造粒乾燥時間を約1/3に短縮し、最終製剤の流動性と貯蔵安定性を向上させます。",
    [
      { label: "형태", value: "백색 미세분말" },
...

  {
    ...
    name: "SN-A81 침전 실리카",
    enName: "SN-A81 · Precipitated Silica", jaName: "SN-A81 沈降シリカ",
    ...
    description:
      "SN-A81은 BET 비표면적 700~750 m²/g의 초고비표면적을 구현한 고순도 침전 실리카(Precipitated Silica)입니다. 일반적인 침전 실리카(150~250 m²/g) 대비 3~4배 수준의 극도로 넓은 표면적을 자랑하며, 이는 제품의 주요 경쟁력입니다.",
    enDescription:
      "SN-A81 is a high-purity precipitated silica achieving an ultra-high BET specific surface area of 700–750 m²/g. This is 3–4 times greater than typical precipitated silica (150–250 m²/g), which is the product's core competitive advantage.", jaDescription: "SN-A81はBET比表面積700~750 m²/gの超高比表面積を実現した高純度沈降シリカ(Precipitated Silica)です。一般的な沈降シリカ(150~250 m²/g)と比較して3~4倍の極めて広い表面積を誇り、これが製品の主な競争力となっています。",
    image: precipitatedSilica,
    category: "precipitated",
    features: [
    ...
    specs: [
      { label: "등급 (Grade)", value: "SN-A81", enLabel: "Grade", jaLabel: "グレード (Grade)" },
...
const fumedExtProducts: ProductDetail[] = [
  mkFS("SN-FCT-380", "기상법(흄드) 이산화규소", "Fumed Silica", "ヒュームド(気相法)シリカ",
    "BET 380 m²/g · 초고비표면적 친수성 흄드 실리카",
    "BET 380 m²/g — ultra-high SSA hydrophilic fumed silica",
    "BET 380 m²/g · 超高比表面積の親水性ヒュームドシリカ",
    "SN-FCT-380은 BET 380 ± 30 m²/g의 초고비표면적을 갖춘 친수성 흄드 실리카입니다. SiO₂ ≥ 99.8%의 고순도, 낮은 강열감량과 미세한 체잔사 관리로 실리콘 고무, 열경화성 도료, 반응성 접착제, 의약품 캐리어 등 정밀 산업에 사용되며, 소량으로도 강력한 요변성·증점·보강 효과를 발휘합니다.",
    "SN-FCT-380 is a hydrophilic fumed silica with ultra-high BET of 380 ± 30 m²/g. SiO₂ ≥ 99.8%, low ignition loss and tightly controlled 45 μm sieve residue make it suitable for silicone rubber, thermosetting paints, reactive adhesives and pharmaceutical carriers — delivering strong thixotropy, thickening and reinforcement at low loadings.",
    "SN-FCT-380はBET 380 ± 30 m²/gの超高比表面積を持つ親水性ヒュームドシリカです。SiO₂ ≥ 99.8%の高純度、低い強熱減量と微細な篩残管理により、シリコーンゴム、熱硬化性塗料、反応性接着剤、医薬品キャリアなど精密産業に使用され、少量で強力なチキソ性・増粘・補強効果を発揮します。",
    [
  ...
  mkFS("SN-FCT-200", "기상법(흄드) 이산화규소", "Fumed Silica", "ヒュームド(気相法)シリカ",
    ...
    "SN-FCT-200은 BET 200 ± 30 m²/g 의 중간 비표면적을 가진 범용 흄드 실리카로, 도료·잉크·접착제·실리콘 실란트·의약품·화장품 등 광범위한 산업에서 표준 등급으로 사용됩니다. 침전실리카 SN-CT-200(소광제)과는 공정·용도가 전혀 다른 별개 제품입니다.",
    "SN-FCT-200 is a general-purpose fumed silica with medium BET 200 ± 30 m²/g, used as a standard grade in paints, inks, adhesives, silicone sealants, pharmaceuticals and cosmetics. Note: this is a distinct product from precipitated SN-CT-200 (matting agent) — different process and applications.",
    "SN-FCT-200はBET 200 ± 30 m²/gの中間比表面積を持つ汎用ヒュームドシリカで、塗料・インキ・接着剤・シリコーンシーラント・医薬品・化粧品など幅広い産業で標準グレードとして使用されます。沈降シリカSN-CT-200(艶消し剤)とは工程・用途が異なる別製品です。",
    [
  ...
  mkFS("SN-FCT-150", "기상법(흄드) 이산화규소", "Fumed Silica", "ヒュームド(気相法)シリカ",
    "BET 150 m²/g · 저구조 등급 친수성 흄드 실리카",
    "BET 150 m²/g — low-structure hydrophilic fumed silica",
    "BET 150 m²/g · 低構造グレードの親水性ヒュームドシリカ",
    "SN-FCT-150은 BET 150 ± 30 m²/g의 저구조 친수성 흄드 실리카로, 실리콘 고무 배합·투명 실란트·저점도 접착제 등 상대적으로 낮은 증점 효과와 우수한 광학 특성이 요구되는 배합에 적합합니다. 10 kg 다층 크라프트지 포대로 공급됩니다.",
    "SN-FCT-150 is a low-structure hydrophilic fumed silica (BET 150 ± 30 m²/g) suitable for silicone rubber compounds, transparent sealants and low-viscosity adhesives that require moderate thickening and excellent optical clarity. Supplied in 10 kg multi-layer kraft bags.",
    "SN-FCT-150はBET 150 ± 30 m²/gの低構造親水性ヒュームドシリカで、シリコーンゴム配合・透明シーラント・低粘度接着剤など相対的に低い増粘効果と優れた光学特性が要求される配合に適合します。10 kg多層クラフト紙袋で供給されます。",
    [
  ...
  mkFS("SN-FCT-151", "소수성 기상법 이산화규소", "Hydrophobic Fumed Silica", "疎水性ヒュームド(気相法)シリカ",
    ...
    "SN-FCT-151은 BET 150 ± 25 m²/g의 흄드 실리카를 소수화 처리한 소수성 등급으로, 유성·용제형 도료의 안료 침강 방지, 실리콘 고무·화장품의 요변성 부여에 사용됩니다. SiO₂ ≥ 99.98% · 탄소함량 0.6–1.2%로 우수한 소수성과 비극성 매체 내 분산성을 제공합니다.",
    "SN-FCT-151 is a hydrophobic-treated fumed silica grade (BET 150 ± 25 m²/g) used for anti-settling of pigments in solvent-borne paints, and thixotropy in silicone rubber and cosmetics. SiO₂ ≥ 99.98% and carbon content 0.6–1.2% provide strong hydrophobicity and dispersion in non-polar media.",
    "SN-FCT-151はBET 150 ± 25 m²/gのヒュームドシリカを疎水化処理した疎水性グレードで、油性・溶剤型塗料の顔料沈降防止、シリコーンゴム・化粧品のチキソ性付与に使用されます。SiO₂ ≥ 99.98%、炭素含有量0.6–1.2%で優れた疎水性と非極性媒体内分散性を提供します。",
    [
...
const hgmApps = [
  "항공우주 보조재 · 경량 구조 충전재 (HN10 · HN16 · HN20)",
  "항공우주용 접착제 및 실런트 (HN25 · HN32 · HN38 · HN40)",
  "5G 통신 관련 저유전 플라스틱 (HN46HS · HN16K · HN60HS · HN18K)",
  "복합 인쇄회로기판(PCB) 저유전 충전재 (HN46HS · HN46 · HN60HS · HN18K)",
  "단열 · 차열 코팅 및 보온 도료 (HN20 · HN25 · HN32 · HN38 · HN40 · HN46)",
  "인조대리석 · 인조석재 경량화 (HN25 · HN32 · HN38 · HN40)",
  "퍼티 · 보수용 패치 컴파운드 (HN25 · HN32 · HN38 · HN40)",
  "타일 접착 모르타르 · 줄눈재 (HN32 · HN38 · HN40)",
  "툴링 플레이트 · 목형/모델링 소재 (HN25 · HN32 · HN38 · HN40)",
  "무기질 단열 보드 (HN20 · HN25)",
  "경량 가구 · 목재 대체 소재 (HN20)",
  "폴리우레탄 사출 · 발포 성형 (HN20 · HN25 · HN32 · HN38 · HN40 · HN46)",
  "SMC / BMC 복합 성형 소재 (HN40 · HN46 · HN60)",
  "플라스틱 경량화 마스터배치 (HN32 · HN38 · HN40 · HN46 · HN60)",
  "사출 · 압출 성형 경량 충전재 (HN40 · HN46 · HN60)",
  "볼링공 코어 등 스포츠 용품 (HN20 · HN25 · HN32 · HN38 · HN40)",
  "신세틱 폼(Syntactic Foam) 합성 발포체 (HN20 · HN25 · HN32 · HN38 · HN40 · HN46 · HN60)",
  "유정 시멘팅용 경량 본드 시멘트 (HN40 · HN46 · HN46HS · HN16K · HN60HS · HN18K)",
  "저밀도 시추 이수(Drilling Fluid) (HN60 · HN60HS · HN18K)",
  "보온 배관 · 단열 파이프 라이닝 (HN40 · HN46 · HN60)",
  "심해 부력재(Buoyancy Material) (HN25 · HN32 · HN38 · HN40 · HN46 · HN60)",
  "선박용 경량 퍼티 (HN20)",
];
const hgmAppsEn = [
  "Aerospace auxiliary and lightweight structural fillers (HN10 · HN16 · HN20)",
  "Aerospace adhesives and sealants (HN25 · HN32 · HN38 · HN40)",
  "5G-related low-dielectric plastics (HN46HS · HN16K · HN60HS · HN18K)",
  "Composite printed circuit boards (HN46HS · HN46 · HN60HS · HN18K)",
  "Heat-insulation and thermal-barrier coatings (HN20 · HN25 · HN32 · HN38 · HN40 · HN46)",
  "Artificial stone and engineered stone lightweighting (HN25 · HN32 · HN38 · HN40)",
  "Patch putty and repair compounds (HN25 · HN32 · HN38 · HN40)",
  "Tile adhesive mortar and grout (HN32 · HN38 · HN40)",
  "Tooling plate and modelling board (HN25 · HN32 · HN38 · HN40)",
  "Inorganic thermal insulation board (HN20 · HN25)",
  "Lightweight furniture and wood substitute (HN20)",
  "Polyurethane injection moulding and foaming (HN20 · HN25 · HN32 · HN38 · HN40 · HN46)",
  "SMC / BMC composite moulding (HN40 · HN46 · HN60)",
  "Plastics lightweighting masterbatch (HN32 · HN38 · HN40 · HN46 · HN60)",
  "Injection and extrusion moulding lightweight filler (HN40 · HN46 · HN60)",
  "Bowling ball cores and sporting goods (HN20 · HN25 · HN32 · HN38 · HN40)",
  "Syntactic foam (HN20 · HN25 · HN32 · HN38 · HN40 · HN46 · HN60)",
  "Lightweight oil-well bond cement (HN40 · HN46 · HN46HS · HN16K · HN60HS · HN18K)",
  "Low-density drilling fluid (HN60 · HN60HS · HN18K)",
  "Insulated and heat-preservation pipe (HN40 · HN46 · HN60)",
  "Deep-sea buoyancy material (HN25 · HN32 · HN38 · HN40 · HN46 · HN60)",
  "Marine ship putty (HN20)",
];
const hgmAppsJa = [
  "航空宇宙補助材・軽量構造充填材 (HN10 · HN16 · HN20)",
  "航空宇宙用接着剤・シーラント (HN25 · HN32 · HN38 · HN40)",
  "5G関連の低誘電プラスチック (HN46HS · HN16K · HN60HS · HN18K)",
  "複合プリント基板(PCB)用低誘電充填材 (HN46HS · HN46 · HN60HS · HN18K)",
  "断熱・遮熱コーティングおよび保温塗料 (HN20 · HN25 · HN32 · HN38 · HN40 · HN46)",
  "人造大理石・人造石材の軽量化 (HN25 · HN32 · HN38 · HN40)",
  "パテ・補修用パッチコンパウンド (HN25 · HN32 · HN38 · HN40)",
  "タイル接着モルタル・目地材 (HN32 · HN38 · HN40)",
  "ツーリングプレート・モデリング素材 (HN25 · HN32 · HN38 · HN40)",
  "無機質断熱ボード (HN20 · HN25)",
  "軽量家具・木材代替素材 (HN20)",
  "ポリウレタン射出・発泡成形 (HN20 · HN25 · HN32 · HN38 · HN40 · HN46)",
  "SMC / BMC 複合成形素材 (HN40 · HN46 · HN60)",
  "プラスチック軽量化マスターバッチ (HN32 · HN38 · HN40 · HN46 · HN60)",
  "射出・押出成形用軽量充填材 (HN40 · HN46 · HN60)",
  "ボウリングボールコアなどスポーツ用品 (HN20 · HN25 · HN32 · HN38 · HN40)",
  "シンタクチックフォーム(合成発泡体) (HN20 · HN25 · HN32 · HN38 · HN40 · HN46 · HN60)",
  "油井セメンチング用軽量ボンドセメント (HN40 · HN46 · HN46HS · HN16K · HN60HS · HN18K)",
  "低密度掘削泥水(Drilling Fluid) (HN60 · HN60HS · HN18K)",
  "保温配管・断熱パイプ (HN40 · HN46 · HN60)",
  "深海用浮力材(Buoyancy Material) (HN25 · HN32 · HN38 · HN40 · HN46 · HN60)",
  "船舶用軽量パテ (HN20)",
];

const hollowGlassMicrospheres: ProductDetail = {
  slug: "hollow-glass-microspheres",
  name: "중공 유리 마이크로스피어",
  enName: "Hollow Glass Microspheres (HGM)",
  jaName: "中空ガラスマイクロスフェア",
  tagline: "SiO₂ ≥ 72.0% 붕규산염 유리 기반 초경량 충전재 · 진밀도 0.22~0.55 g/cm³ · D50 30~60 µm",
  enTagline: "Ultra-Lightweight Borosilicate Filler with SiO₂ ≥ 72.0% · True Density 0.22–0.55 g/cm³ · D50 30–60 µm",
  jaTagline: "SiO₂ ≥ 72.0% のホウケイ酸ガラス製 超軽量充填材 · 真密度 0.22~0.55 g/cm³ · D50 30~60 µm",
  description:
    "중공 유리 마이크로스피어(Hollow Glass Microspheres, HGM)는 주화학 성분이 실리카(SiO₂) 함량 72.0% 이상을 차지하는 붕규산염 유리로 제조된 초경량 충전재입니다. 마이크로미터 크기의 유리막이 구(球)를 이루고, 그 내부는 질소(N₂) 가스로 채워진 완전 밀폐 중공 구조를 가지며, 외관은 백색 분말 형태입니다. 무기질 비금속 소재이면서도 밀도가 물보다 훨씬 낮아 '신시대의 우주 소재(Space Material of the New Era)'로 불립니다.\n\n진밀도 0.22~0.55 g/cm³, 벌크밀도 0.13~0.35 g/cm³로 일반 충전재(탄산칼슘·탈크 등) 대비 무게를 획기적으로 줄여주며, 부유율 95% 이상으로 중공률이 매우 높습니다. 그럼에도 압축강도는 30~80 MPa 수준을 확보하여 사출·압출·고압 혼련 공정에서도 파쇄 없이 형상을 유지합니다. D50 입도는 30~60 µm이며, SiO₂ ≥ 72.0%, Al₂O₃ 5.0~12.0%의 조성으로 화학적 안정성과 내식성이 뛰어나고, 수분 함량은 0.30% 이하, 백색도 88.0 이상, pH 7.0~9.0의 중성 영역이라 대부분의 수지·수계 시스템과 안정적으로 혼용됩니다.\n\n구(球) 형태 특유의 '볼 베어링 효과'로 컴파운드 점도를 낮추고 유동성과 분산성을 개선하며, 내부 질소 가스층 덕분에 열전도율이 낮아 우수한 단열 성능을 발휘합니다. 또한 저유전율(Low Dk)·저유전손실 특성으로 5G 통신 부품과 저유전 인쇄회로기판(PCB) 소재에 활발히 적용되고 있으며, 자기윤활성·차음성·비흡수성·난연성·내부식성 등도 함께 갖추고 있습니다.\n\n등급은 HN10부터 HN60, 그리고 고강도 계열인 HN46HS·HN60HS·HN16K·HN18K까지 밀도와 압축강도 조합에 따라 다양하게 구성되며, 용도별 권장 그레이드를 기준으로 맞춤 공급이 가능합니다.",
  enDescription:
    "Hollow Glass Microspheres (HGM) are ultra-lightweight fillers made of borosilicate glass whose main chemical component is silica (SiO₂) at 72.0% or higher. Their structure consists of hollow spheres encapsulated by micrometer-sized glass walls, with the internal cavity filled with nitrogen gas; the appearance is a white powder. Though an inorganic non-metallic material, its density is far below that of water, earning it the name \"space material of the new era\".\n\nWith a true density of 0.22–0.55 g/cm³ and bulk density of 0.13–0.35 g/cm³, HGM dramatically reduces the weight of compounds compared with conventional fillers such as calcium carbonate or talc, and its floatation rate exceeds 95%. Despite this, compressive strength reaches 30–80 MPa, so the spheres survive injection, extrusion and high-shear mixing without crushing. D50 particle size is 30–60 µm; the composition of SiO₂ ≥ 72.0% and Al₂O₃ 5.0–12.0% provides excellent chemical stability and corrosion resistance, while moisture ≤ 0.30%, whiteness ≥ 88.0 and a neutral pH of 7.0–9.0 make it compatible with most resin and waterborne systems.\n\nThe spherical geometry produces a ball-bearing effect that lowers compound viscosity and improves flow and dispersion, while the internal nitrogen layer delivers low thermal conductivity and outstanding insulation. Low dielectric constant and low dielectric loss make it well suited to 5G components and low-Dk printed circuit boards, and it also offers self-lubrication, sound insulation, non-water absorption, fire resistance and corrosion resistance.\n\nGrades run from HN10 through HN60, plus high-strength types HN46HS, HN60HS, HN16K and HN18K, combining different density and compressive strength targets; supply is tailored to the recommended grade for each application.",
  jaDescription:
    "中空ガラスマイクロスフェア(Hollow Glass Microspheres, HGM)は、主要化学成分としてシリカ(SiO₂)を72.0%以上含むホウケイ酸ガラスで製造された超軽量充填材です。マイクロメートルサイズのガラス膜が球体を形成し、内部は窒素(N₂)ガスで満たされた完全密閉の中空構造で、外観は白色粉末です。無機非金属材料でありながら密度が水よりはるかに低く、「新時代の宇宙材料」と呼ばれています。\n\n真密度0.22~0.55 g/cm³、かさ密度0.13~0.35 g/cm³で、炭酸カルシウムやタルクなど一般的な充填材に比べ重量を大幅に低減し、浮遊率は95%以上です。それでも圧縮強度は30~80 MPaを確保しており、射出・押出・高せん断混練でも破砕せず形状を維持します。D50は30~60 µm、SiO₂ ≥ 72.0%・Al₂O₃ 5.0~12.0%の組成により化学的安定性と耐食性に優れ、水分0.30%以下、白色度88.0以上、pH 7.0~9.0の中性域で、多くの樹脂・水系システムと安定して併用できます。\n\n球形特有のボールベアリング効果によりコンパウンド粘度を下げ、流動性と分散性を改善し、内部の窒素ガス層により熱伝導率が低く優れた断熱性能を発揮します。また低誘電率(Low Dk)・低誘電損失特性から5G通信部品や低誘電プリント基板材料にも広く適用され、自己潤滑性・遮音性・非吸水性・難燃性・耐食性も併せ持ちます。\n\nグレードはHN10からHN60、さらに高強度系のHN46HS・HN60HS・HN16K・HN18Kまで、密度と圧縮強度の組み合わせに応じて幅広く構成され、用途別推奨グレードに基づくカスタム供給が可能です。",
  image: hgmImg,
  detailImage: hgmImg,
  category: "advanced-series",
  parentSlug: "applied-silica-materials",
  features: [
    { title: "🪶 초저밀도 · 진밀도 0.22~0.55 g/cm³", desc: "물보다 가벼운 중공 구조로 제품 경량화 및 원가 절감 실현", enTitle: "🪶 Ultra-Low Density (0.22–0.55 g/cm³)", jaTitle: "🪶 超低密度 · 真密度 0.22~0.55 g/cm³", enDesc: "Hollow structure lighter than water delivers weight reduction and cost savings", jaDesc: "水より軽い中空構造で製品の軽量化とコスト削減を実現" },
    { title: "💪 압축강도 30~80 MPa", desc: "초경량임에도 고압 사출·압출 공정에서 파쇄 없이 형상 유지", enTitle: "💪 Compressive Strength 30–80 MPa", jaTitle: "💪 圧縮強度 30~80 MPa", enDesc: "Survives high-pressure injection and extrusion without crushing despite its light weight", jaDesc: "超軽量ながら高圧射出・押出工程でも破砕せず形状を維持" },
    { title: "🧊 저열전도 · 우수한 단열성", desc: "내부 질소 가스층이 열 이동을 차단 — 단열 도료·보온재에 최적", enTitle: "🧊 Low Thermal Conductivity", jaTitle: "🧊 低熱伝導・優れた断熱性", enDesc: "The internal nitrogen layer blocks heat transfer — ideal for insulating coatings and materials", jaDesc: "内部の窒素ガス層が熱移動を遮断 — 断熱塗料・保温材に最適" },
    { title: "📡 저유전율(Low Dk) 특성", desc: "5G 통신 부품·저유전 PCB·복합 기판용 기능성 충전재", enTitle: "📡 Low Dielectric Constant", jaTitle: "📡 低誘電率(Low Dk)特性", enDesc: "Functional filler for 5G components, low-Dk PCBs and composite substrates", jaDesc: "5G通信部品・低誘電PCB・複合基板用の機能性充填材" },
    { title: "🌀 볼 베어링 효과 · 우수한 유동성", desc: "완전 구형 입자가 점도를 낮추고 분산성과 성형성을 향상", enTitle: "🌀 Ball-Bearing Effect", jaTitle: "🌀 ボールベアリング効果・優れた流動性", enDesc: "Perfectly spherical particles lower viscosity and improve dispersion and moldability", jaDesc: "完全球形粒子が粘度を下げ、分散性と成形性を向上" },
    { title: "🛡️ 비흡수 · 난연 · 내부식", desc: "수분 ≤0.30%, 백색도 ≥88.0, pH 7~9 중성 — 화학적 안정성 우수", enTitle: "🛡️ Non-Absorbent · Fire & Corrosion Resistant", jaTitle: "🛡️ 非吸水・難燃・耐食", enDesc: "Moisture ≤0.30%, whiteness ≥88.0, neutral pH 7–9 with excellent chemical stability", jaDesc: "水分 ≤0.30%、白色度 ≥88.0、pH 7~9の中性で化学的安定性に優れる" },
  ],
  specs: [
    { label: "제품명", value: "중공 유리 마이크로스피어 (空心玻璃微珠 / HGM)", enValue: "Hollow Glass Microspheres (HGM)", jaValue: "中空ガラスマイクロスフェア (HGM)", enLabel: "Product Name", jaLabel: "製品名" },
    { label: "재질", value: "고알칼리 붕규산염 유리 (Alkaline-rich Borosilicate Glass)", enValue: "Alkaline-rich borosilicate glass", jaValue: "高アルカリ ホウケイ酸ガラス", enLabel: "Material", jaLabel: "材質" },
    { label: "이산화규소 (SiO₂)", value: "≥ 72.0 %", note: "주화학 성분 — 유리 골격 형성", enNote: "Main chemical component forming the glass network", jaNote: "主要化学成分 — ガラス骨格を形成", enLabel: "Silicon Dioxide (SiO₂)", jaLabel: "二酸化ケイ素 (SiO₂)" },
    { label: "산화알루미늄 (Al₂O₃)", value: "5.0 ~ 12.0 %", note: "화학적 내구성 및 강도 보강", enNote: "Reinforces chemical durability and strength", jaNote: "化学的耐久性と強度を補強", enLabel: "Aluminium Oxide (Al₂O₃)", jaLabel: "酸化アルミニウム (Al₂O₃)" },
    { label: "진밀도 (True Density)", value: "0.22 ~ 0.55 g/cm³", enValue: "0.22–0.55 g/cm³", jaValue: "0.22~0.55 g/cm³", enLabel: "True Density", jaLabel: "真密度" },
    { label: "벌크밀도 (Bulk Density)", value: "0.13 ~ 0.35 g/cm³", enValue: "0.13–0.35 g/cm³", jaValue: "0.13~0.35 g/cm³", enLabel: "Bulk Density", jaLabel: "かさ密度" },
    { label: "D50 평균 입도", value: "30 ~ 60 µm", enValue: "30–60 µm", jaValue: "30~60 µm", enLabel: "D50 Particle Size", jaLabel: "D50平均粒径" },
    { label: "부유율 (Floatation Rate)", value: "≥ 95 %", note: "중공 구조 비율 지표", enNote: "Indicator of hollow-sphere content", jaNote: "中空構造比率の指標", enLabel: "Floatation Rate", jaLabel: "浮遊率" },
    { label: "압축강도", value: "30 ~ 80 MPa", enValue: "30–80 MPa", jaValue: "30~80 MPa", enLabel: "Compressive Strength", jaLabel: "圧縮強度" },
    { label: "수분 함량", value: "≤ 0.30 %", enValue: "≤ 0.30%", jaValue: "≤ 0.30 %", enLabel: "Moisture Content", jaLabel: "水分含有量" },
    { label: "백색도", value: "≥ 88.0", enValue: "≥ 88.0", jaValue: "≥ 88.0", enLabel: "Whiteness", jaLabel: "白色度" },
    { label: "pH 값", value: "7.0 ~ 9.0", enValue: "7.0–9.0", jaValue: "7.0~9.0", enLabel: "pH Value", jaLabel: "pH値" },
    { label: "내부 충전 가스", value: "질소 (N₂)", enValue: "Nitrogen (N₂)", jaValue: "窒素 (N₂)", enLabel: "Internal Gas", jaLabel: "内部封入ガス" },
    { label: "외관", value: "백색 분말 (완전 구형 중공 입자)", enValue: "White powder (perfectly spherical hollow particles)", jaValue: "白色粉末(完全球形の中空粒子)", enLabel: "Appearance", jaLabel: "外観" },
    { label: "그레이드", value: "HN10 · HN16 · HN20 · HN25 · HN32 · HN38 · HN40 · HN46 · HN60 / 고강도: HN46HS · HN60HS · HN16K · HN18K", enValue: "HN10 · HN16 · HN20 · HN25 · HN32 · HN38 · HN40 · HN46 · HN60 / High-strength: HN46HS · HN60HS · HN16K · HN18K", jaValue: "HN10 · HN16 · HN20 · HN25 · HN32 · HN38 · HN40 · HN46 · HN60 / 高強度: HN46HS · HN60HS · HN16K · HN18K", enLabel: "Grades", jaLabel: "グレード" },
    { label: "원산지", value: "중국 (China)", enValue: "China", jaValue: "中国", enLabel: "Origin", jaLabel: "原産地" },
    { label: "포장", value: "경량 크라프트 지대 · 빅백 · OEM 대응", enValue: "Lightweight kraft bags · big bags · OEM", jaValue: "軽量クラフト紙袋 · ビッグバッグ · OEM対応", enLabel: "Packaging", jaLabel: "包装" },
  ],
  subModelsColumnLabel: { ko: "권장 용도", en: "Recommended Use", ja: "推奨用途" },
  subModels: [
    { code: "HN10 / HN16 / HN20", spec: "최저밀도 · 항공우주 보조재, 무기질 단열보드, 경량 가구·목재 대체, 선박용 퍼티", enSpec: "Lowest density — aerospace auxiliaries, inorganic insulation board, lightweight furniture / wood substitute, ship putty", jaSpec: "最低密度 — 航空宇宙補助材、無機質断熱ボード、軽量家具・木材代替、船舶用パテ" },
    { code: "HN25 / HN32 / HN38 / HN40", spec: "범용 · 접착제/실런트, 단열 도료, 인조석재, 퍼티·패치, 툴링 플레이트, 타일 모르타르", enSpec: "General purpose — adhesives/sealants, insulating coatings, artificial stone, putty/patch, tooling plate, tile mortar", jaSpec: "汎用 — 接着剤・シーラント、断熱塗料、人造石材、パテ・パッチ、ツーリングプレート、タイルモルタル" },
    { code: "HN46 / HN60", spec: "고강도 · SMC/BMC, 사출·압출 성형, 보온 파이프, 신세틱 폼, 심해 부력재", enSpec: "High strength — SMC/BMC, injection & extrusion moulding, insulated pipe, syntactic foam, deep-sea buoyancy", jaSpec: "高強度 — SMC/BMC、射出・押出成形、保温パイプ、シンタクチックフォーム、深海用浮力材" },
    { code: "HN46HS / HN60HS / HN16K / HN18K", spec: "초고강도 · 5G 저유전 플라스틱, 복합 PCB, 유정 시멘팅, 저밀도 시추 이수", enSpec: "Ultra-high strength — 5G low-Dk plastics, composite PCB, oil-well cementing, low-density drilling fluid", jaSpec: "超高強度 — 5G低誘電プラスチック、複合PCB、油井セメンチング、低密度掘削泥水" },
  ],
  applications: hgmApps,
};

productCatalog.push(appliedSilicaMaterials, amorphousCeramicFrit, hollowGlassMicrospheres);
