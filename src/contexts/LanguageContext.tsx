...
const dict: Record<string, { ko: string; en: string; ja?: string }> = {
  ...
  "footer.address": { ko: "경기도 화성시 마도면 마도공단로 202 1F", en: "202 Mado Industrial Complex-ro, Mado-myeon, Hwaseong, Gyeonggi-do, 1F", ja: "京畿道華城市麻道面麻道工団路202 1F" },
  ...
  "ab.pt.p1": { ko: "주식회사 비에이알은 글로벌 실리카 전문 기업인 <strong>SINOTENNG-SILICA</strong>와 파트너십을 맺고 고품질 실리카 소재를 국내에 공급하고 있습니다.", en: "BAR Co., Ltd. partners with <strong>SINOTENNG-SILICA</strong>, a global silica specialist, to supply high-quality silica materials in Korea.", ja: "株式会社BARは、グローバルシリカ専門企業である<strong>SINOTENNG-SILICA</strong>とパートナーシップを結び、高品質シリカ素材を国内に供給しています。" },
  ...
  "ab.pt.p4": { ko: "저희 주식회사 비에이알은 SINOTENNG-SILICA의 검증된 기술력과 안정적인 글로벌 공급망을 바탕으로 고객사의 니즈에 최적화된 최상의 소재 솔루션을 제공하겠습니다.", en: "Backed by SINOTENNG-SILICA's proven technology and stable global supply chain, BAR Co., Ltd. delivers material solutions optimized to each customer's needs.", ja: "当社株式会社BARはSINOTENNG-SILICAの実証された技術力と安定したグローバル供給網を基盤に、お客様のニーズに最適化された最良の素材ソリューションを提供します。" },
