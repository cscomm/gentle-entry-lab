...
const advSeriesProducts: ProductDetail[] = [
  ...
  },
  {
    ...
    name: "고순도 용융 실리카 분말 (SL-HF04)",
    enName: "SL-HF04 · Ultra-High-Purity Fused Silica Powder",
    jaName: "SL-HF04 高純度溶融シリカ粉末",
    tagline: "SiO₂ 99.96% · D50 3.8µm — 반도체·전자소재용 초고순도 미분 용융 실리카",
    enTagline: "SiO₂ 99.96% · D50 3.8 µm — Ultra-High-Purity Micronized Fused Silica for Semiconductor & Electronic Materials",
    jaTagline: "SiO₂ 99.96% · D50 3.8µm — 半導体・電子素材用 超高純度微粉溶融シリカ",
    description:
