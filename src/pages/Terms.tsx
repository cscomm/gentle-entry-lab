...
const sections: { title: string; body: string[] }[] = [
  { title: "제1조 목적", body: ["본 이용약관은 \"silica\"(이하 \"사이트\")의 서비스의 이용조건과 운영에 관한 제반 사항 규정을 목적으로 합니다."] },
  { title: "제2조 용어의 정의", body: [
  ...
  { title: "제3조 약관 외 준칙", body: ["운영자는 필요한 경우 별도로 운영정책을 공지 안내할 수 있으며, 본 약관과 운영정책이 중첩될 경우 운영정책이 우선 적용됩니다."] },
  { title: "제4조 이용계약 체결", body: [
  ...
  { title: "제13조 게시물의 보관", body: ["사이트 운영자가 불가피한 사정으로 본 사이트를 중단하게 될 경우, 회원에게 사전 공지를 하고 게시물의 이전이 쉽도록 모든 조치를 하기 위해 노력합니다."] },
  { title: "제14조 게시물에 대한 저작권", body: [
  ...
  { title: "부칙", body: ["이 약관은 사이트 개설일부터 시행합니다."] },
];
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="border-b border-border bg-secondary/40 pt-32 pb-12">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <h1 className="mt-5 text-3xl font-bold md:text-4xl">이용약관</h1>
          <p className="mt-3 text-sm text-muted-foreground">SiLiCA 웹사이트 이용에 적용되는 약관입니다.</p>
        </div>
      </section>
