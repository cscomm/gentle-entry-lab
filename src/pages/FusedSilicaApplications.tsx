      ...
      <section className="bg-gradient-to-br from-secondary/60 via-background to-background pt-32 pb-16 md:pt-40 md:pb-20">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <p className="mt-5 max-w-3xl text-base leading-relaxed text-muted-foreground md:text-lg">
            {t(
              "용융실리카(Fused Silica)는 천연 석영을 1,800℃ 이상의 초고온에서 용융·급냉하여 얻는 비정질 이산화규소(SiO₂) 소재로, 극저 열팽창(0.5~0.6 ×10⁻⁶/℃)·탁월한 열충격 저항·초고온 안정성·우수한 화학적 내구성·저 유전율·고 전기 절연을 동시에 갖춘 첨단 산업의 핵심 원료입니다. A · B · C 등급과 전 SL 시리즈(SL-QG · SL-QG-L · SL-YRG · SL-RG · SL-FL · SL-HRG · SL-FS · SL-HF04) 라인업이 반도체·광학·항공·방산·태양광·에너지·정밀 주조·특수 유리·산업용 컴파운드 등 국가 기간산업 전반에 걸쳐 사용되고 있습니다.",
              "Fused silica is an amorphous SiO₂ material produced by melting natural quartz above 1,800 °C and rapidly quenching it. It uniquely combines ultra-low CTE (0.5–0.6 ×10⁻⁶/°C), exceptional thermal-shock resistance, ultra-high temperature stability, superior chemical durability, low dielectric constant and high electrical insulation — a foundational material for advanced industries. Grades A / B / C together with the full SL-series lineup (SL-QG, SL-QG-L, SL-YRG, SL-RG, SL-FL, SL-HRG, SL-FS, SL-HF04) are used across semiconductor, optics, aerospace, defense, solar, energy, precision casting, specialty glass and industrial-compound sectors.",
              "溶融シリカ(Fused Silica)は、天然石英を1,800℃以上の超高温で溶融・急冷して得られる非晶質二酸化ケイ素(SiO₂)素材で、極低熱膨張(0.5~0.6 ×10⁻⁶/℃)・卓越した耐熱衝撃性・超高温安定性・優れた化学耐久性・低誘電率・高電気絶縁性を兼ね備えた先端産業の核心原料です。A・B・Cグレードと全SLシリーズ(SL-QG・SL-QG-L・SL-YRG・SL-RG・SL-FL・SL-HRG・SL-FS・SL-HF04)ラインアップが、半導体・光学・航空・防衛・太陽光・エネルギー・精密鋳造・特殊ガラス・産業用コンパウンドなど国家基幹産業全般で使用されています。"
            )}
          </p>
        </div>
      </section>
