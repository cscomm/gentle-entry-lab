...
const products = [
  ...
  { img: "/src/assets/crystalline-silica.jpg", slug: "crystalline-silica", title: "쿼츠 · 결정질 실리카", enTitle: "Quartz · Crystalline Silica", jaTitle: "クォーツ・結晶質シリカ", desc: "SL-YJG · SL-JG · SL-CL · SL-HJG · SL-CS — α-Quartz 결정질 실리카 전 형상 라인업 통합 카테고리", enDesc: "SL-YJG · SL-JG · SL-CL · SL-HJG · SL-CS — unified α-quartz crystalline silica lineup covering every shape and function.", jaDesc: "SL-YJG · SL-JG · SL-CL · SL-HJG · SL-CS — α-Quartz結晶質シリカの全形状ラインアップ統合カテゴリ", cat: "쿼츠 · 결정질 실리카" },
  ...
  { img: sandGranuleImg, slug: "silica-sand-granule", title: "실리카 분말·입자", enTitle: "Silica Powder & Granule", jaTitle: "シリカパウダー・粒", desc: "SL-CS / SL-FS — 결정·용융 석영사 및 입자 — 내화·주조·정밀 산업용", enDesc: "SL-CS / SL-FS — crystalline & fused quartz sand and granules for refractory, foundry and precision industries.", jaDesc: "SL-CS / SL-FS — 結晶・溶融石英砂および粒 — 耐火・鋳造・精密産業用", cat: "실리카 분말·입자" },
  // Row 2 — Precipitated / Fumed + Lead-Free
